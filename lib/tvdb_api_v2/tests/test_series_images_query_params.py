...
from tvdb_api_v2.models.series_images_query_params import SeriesImagesQueryParams


class TestSeriesImagesQueryParams(unittest.TestCase):
    """ SeriesImagesQueryParams unit test stubs """
    ...
    def testSeriesImagesQueryParams(self):
        """
