...
class TestUpdatesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = tvdb_api_v2.apis.updates_api.UpdatesApi()

    def tearDown(self):
        pass

    def test_updated_query_get(self):
        """
        Test case for updated_query_get

        
        """
        pass

    def test_updated_query_params_get(self):
        """
        Test case for updated_query_params_get
