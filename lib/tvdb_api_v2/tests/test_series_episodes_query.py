...
class TestSeriesEpisodesQuery(unittest.TestCase):
    """ SeriesEpisodesQuery unit test stubs """
    ...
    def testSeriesEpisodesQuery(self):
        """
        Test SeriesEpisodesQuery
        """
        model = tvdb_api_v2.models.series_episodes_query.SeriesEpisodesQuery()
