...
from tvdb_api_v2.models.user_ratings_query_params import UserRatingsQueryParams


class TestUserRatingsQueryParams(unittest.TestCase):
    """ UserRatingsQueryParams unit test stubs """
    ...
    def testUserRatingsQueryParams(self):
        """
