...
class TestSeriesImagesCounts(unittest.TestCase):
    """ SeriesImagesCounts unit test stubs """
    ...
    def testSeriesImagesCounts(self):
        """
        Test SeriesImagesCounts
        """
        model = tvdb_api_v2.models.series_images_counts.SeriesImagesCounts()
