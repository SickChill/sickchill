...
class TestSeriesSearchData(unittest.TestCase):
    """ SeriesSearchData unit test stubs """
    ...
    def testSeriesSearchData(self):
        """
        Test SeriesSearchData
        """
        model = tvdb_api_v2.models.series_search_data.SeriesSearchData()
