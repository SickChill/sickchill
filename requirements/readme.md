List of dependencies [![Requirements Status](https://requires.io/github/SickChill/SickChill/requirements.svg?branch=develop)](https://requires.io/github/SickChill/SickChill/requirements/?branch=develop)
======================
...
:ok: | babelfish | 0.5.5 | Resolved by [#3877](https://github.com/SickChill/SickChill/pull/3877)
:ok: | backports_abc | 0.5
:ok: | backports.ssl-match-hostname | 3.5.0.1
:ok: | beautifulsoup4 | 4.5.3
:ok: | bencode | 1.0 | Resolved by [#3858](https://github.com/SickChill/SickChill/pull/3858) + [#3871](https://github.com/SickChill/SickChill/pull/3871)<br>A newer version (fork) is available: [GH:fuzeman/bencode.py](https://github.com/fuzeman/bencode.py)
...
:ok: | chardet | 3.0.4 | Resolved by [#3870](https://github.com/SickChill/SickChill/pull/3870)
:ok: | configobj | 4.6.0
:ok: | decorator | 4.0.10
...
:ok: | enum34 | 1.0.4
:ok: | enzyme | 0.4.1
:ok: | fake-useragent | 0.1.2 | Note: There's a `ua.json` file that's used by `sickchill.common`,<br>should be moved to a better location.
:warning: | feedparser | [f1dd1bb](https://github.com/kurtmckee/feedparser/tree/f1dd1bb923ebfe6482fc2521c1f150b4032289ec) | Vanilla'd by [#3877](https://github.com/SickChill/SickChill/pull/3877)
:ok: | futures | 3.1.1
...
:ok: | idna | 2.5 | Added in [#3870](https://github.com/SickChill/SickChill/pull/3870)
...
:ok: | oauthlib | 2.0.2 | Added in [#3870](https://github.com/SickChill/SickChill/pull/3870)
...
:ok: | PyGithub | 1.34 | Resolved by [#3877](https://github.com/SickChill/SickChill/pull/3877)
:ok: | PyJWT | 1.5.0 | Added in [#3877](https://github.com/SickChill/SickChill/pull/3877)
:ok: | pymediainfo | 2.0 | as an `.egg` file, loaded by `pkg_resources`
:ok: | pynma | 1.0
:ok: | PySocks | 1.6.7 | Added in [#3877](https://github.com/SickChill/SickChill/pull/3877)
:ok: | pysrt | 1.1.1
:ok: | python-dateutil | 2.6.0 | Resolved by [#3877](https://github.com/SickChill/SickChill/pull/3877)
:exclamation: | python-fanart | 1.4.0 | **Modified**<br>API url was updated. No newer version.
:ok: | python-twitter | 3.3 | Updated in [#3870](https://github.com/SickChill/SickChill/pull/3870)
:ok: | pytz | 2016.4 | as an `.egg` file, loaded by `pkg_resources`
:exclamation: | rarfile | [3e54b22](https://github.com/markokr/rarfile/tree/3e54b222c8703eea64cd07102df7bb9408b582b3) | *v3.0 Github release*<br>**Modified**<br>See [`059dd933#diff-c1f4e96`](https://github.com/SickChill/SickChill/commit/059dd933b9da3a0f83c6cbb4f47c198e5a957fc6#diff-c1f4e968aa545d42d2e462672169da4a)
:warning: | rebulk | [42d0a58](https://github.com/Toilal/rebulk/tree/42d0a58af9d793334616a6582f2a83b0fae0dd5f)
:ok: | requests | 2.18.1 | Updated in [#3870](https://github.com/SickChill/SickChill/pull/3870)
:ok: | requests-oauthlib | 0.8.0 | Added in [#3870](https://github.com/SickChill/SickChill/pull/3870)
:exclamation: | rtorrent-python | 0.2.9 | **Modified**<br>See [commits log for `lib/rtorrent`](https://github.com/SickChill/SickChill/commits/master/lib/rtorrent)
:exclamation: | send2trash | 1.3.0 | **Modified**<br>See [`9ad8114`](https://github.com/SickChill/SickChill/commit/9ad811432ab0ca3292410d29464ce2532361eb55)
...
:ok: | stevedore | 1.10.0
:warning: | subliminal | [7eb7a53](https://github.com/Diaoul/subliminal/tree/7eb7a53fe6bcaf3e01a6b44c8366faf7c96f7f1b) | **Modified**<br>Subscenter provider disabled until fixed upstream, [#3825 `diff-ab7eb9b`](https://github.com/SickChill/SickChill/pull/3825/files#diff-ab7eb9ba0a2d4c74c16795ff40f2bd62)
...
:ok: | tzlocal | 1.4 | Resolved by [#3877](https://github.com/SickChill/SickChill/pull/3877)
:ok: | Unidecode | 0.04.21 | Updated in [#3877](https://github.com/SickChill/SickChill/pull/3877)
:ok: | urllib3 | 1.21.1 | Added in [#3870](https://github.com/SickChill/SickChill/pull/3870)
:ok: | validators | 0.10
:ok: | webencodings | 0.5.1
:ok: | win-inet-pton | 1.0.1 | Required for PySocks on Windows systems<br>Added in [#3877](https://github.com/SickChill/SickChill/pull/3877)
:ok: | xmltodict | 0.11.0 | Resolved by [#3877](https://github.com/SickChill/SickChill/pull/3877)
...
:-------: | :------: | ---------
MultipartPostHandler.py | Unused | Removed in [#3716](https://github.com/SickChill/SickChill/pull/3716)
oauth2 | Outdated | Removed in [#3870](https://github.com/SickChill/SickChill/pull/3870)
simplejson | Unused | Removed in [#3877](https://github.com/SickChill/SickChill/pull/3877)
SocksiPy | Outdated | Replaced with PySocks in [#3877](https://github.com/SickChill/SickChill/pull/3877)
sqliteshelf.py | Unused | Removed in [#3716](https://github.com/SickChill/SickChill/pull/3716)
