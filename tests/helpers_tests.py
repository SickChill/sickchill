...
class HelpersZipTests(unittest.TestCase):
    ...
    def test_is_rar_file(self):
        ...
        self.assertTrue(helpers.is_rar_file('lala.part1.rar'))
        self.assertTrue(helpers.is_rar_file('lala.part01.rar'))
        self.assertTrue(helpers.is_rar_file('lala.part001.rar'))
        self.assertTrue(helpers.is_rar_file('lala.1.rar'))
        self.assertTrue(helpers.is_rar_file('lala.01.rar'))
        self.assertTrue(helpers.is_rar_file('lala.001.rar'))
        self.assertFalse(helpers.is_rar_file('lala.r0'))
        self.assertTrue(helpers.is_rar_file('lala.r00'))
        self.assertFalse(helpers.is_rar_file('lala.r000'))
