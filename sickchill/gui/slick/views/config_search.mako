                        ...
                        <fieldset class="component-group-list">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="randomize_providers" id="randomize_providers"
                                           class="enabler" ${('', 'checked="checked"')[bool(sickchill.RANDOMIZE_PROVIDERS)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="download_propers" id="download_propers"
                                           class="enabler" ${('', 'checked="checked"')[bool(sickchill.DOWNLOAD_PROPERS)]}/>
                                    ...
                                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                        <select id="check_propers_interval" name="check_propers_interval" class="form-control input-sm input150">
                                            ...
                                            % for curInterval in check_propers_interval_text:
                                                <option value="${curInterval}" ${('', 'selected="selected"')[sickchill.CHECK_PROPERS_INTERVAL == curInterval]}>${check_propers_interval_text[curInterval]}</option>
                                            % endfor
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="number" min="1" step="1" name="backlog_days"
                                                   value="${sickchill.BACKLOG_DAYS}" class="form-control input-sm input75"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="number" min="720" step="60" name="backlog_frequency"
                                                   value="${sickchill.BACKLOG_FREQUENCY}" class="form-control input-sm input75"
                                                   id="backlog_frequency" autocapitalize="off"/>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label for="backlog_frequency">${_('time in minutes between searches (min.')} ${sickchill.MIN_BACKLOG_FREQUENCY})</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="number" min="10" step="1" name="dailysearch_frequency"
                                                   id="dailysearch_frequency" value="${sickchill.DAILYSEARCH_FREQUENCY}"
                                                   class="form-control input-sm input75" autocapitalize="off"/>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label for="dailysearch_frequency">${_('time in minutes between searches (min.')} ${sickchill.MIN_DAILYSEARCH_FREQUENCY})</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="number" min="1" step="1" name="usenet_retention"
                                                   value="${sickchill.USENET_RETENTION}" class="form-control input-sm input75"
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="ignore_words" value="${sickchill.IGNORE_WORDS}"
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="require_words" value="${sickchill.REQUIRE_WORDS}"
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="trackers_list" value="${sickchill.TRACKERS_LIST}"
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="ignored_subs_list" value="${sickchill.IGNORED_SUBS_LIST}"
                                                   class="form-control input-sm input350" autocapitalize="off"/>
                                        </div>
                                    </div>
                                    <div class="row">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="allow_high_priority"
                                           id="allow_high_priority" ${('', 'checked="checked"')[bool(sickchill.ALLOW_HIGH_PRIORITY)]}/>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input id="use_failed_downloads" type="checkbox" class="enabler"
                                                   name="use_failed_downloads" ${('', 'checked="checked"')[bool(sickchill.USE_FAILED_DOWNLOADS)]} />
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <input id="delete_failed" type="checkbox"
                                                       name="delete_failed" ${('', 'checked="checked"')[bool(sickchill.DELETE_FAILED)]}/>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <div class="component-group-desc">
                            ...
                            <div id="nzb_method_icon" class="add-client-icon-${sickchill.NZB_METHOD}"></div>
                        </div>
                    </div>
                    <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="use_nzbs" class="enabler"
                                           id="use_nzbs" ${('', 'checked="checked"')[bool(sickchill.USE_NZBS)]}/>
                                    ...
                                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                        <select name="nzb_method" id="nzb_method" class="form-control input-sm input150" title="nzb_method">
                                            ...
                                            % for curAction in ('blackhole', 'sabnzbd', 'nzbget', 'download_station'):
                                                <option value="${curAction}" ${('', 'selected="selected"')[sickchill.NZB_METHOD == curAction]}>${nzb_method_text[curAction]}</option>
                                            % endfor
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div id="sabnzbd_settings">
                                    ...
                                    <div class="field-pair row">
                                        ...
                                        <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input type="text" id="sab_host" name="sab_host" value="${sickchill.SAB_HOST}"
                                                           class="form-control input-sm input350" autocapitalize="off"/>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input type="text" name="sab_username" id="sab_username"
                                                           value="${sickchill.SAB_USERNAME}" class="form-control input-sm input200"
                                    ...
                                    <div class="field-pair row">
                                        ...
                                        <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input
                                                        type="password" name="sab_password" id="sab_password" value="${sickchill.SAB_PASSWORD|hide}"
                                    ...
                                    <div class="field-pair row">
                                        ...
                                        <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input
                                                        type="password" name="sab_apikey" id="sab_apikey" value="${sickchill.SAB_APIKEY|hide}"
                                                        class="form-control input-sm input350" autocapitalize="off"
                                                    />
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input type="text" name="sab_category" id="sab_category"
                                                           value="${sickchill.SAB_CATEGORY}" class="form-control input-sm input200"
                                                           autocapitalize="off"/>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input type="text" name="sab_category_backlog" id="sab_category_backlog"
                                                           value="${sickchill.SAB_CATEGORY_BACKLOG}"
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input type="text" name="sab_category_anime" id="sab_category_anime"
                                                           value="${sickchill.SAB_CATEGORY_ANIME}"
                                                           class="form-control input-sm input200" autocapitalize="off"/>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input type="text" name="sab_category_anime_backlog"
                                                           ...
                                                           value="${sickchill.SAB_CATEGORY_ANIME_BACKLOG}"
                                                           class="form-control input-sm input200" autocapitalize="off"/>
                                                </div>
                                            </div>
                                            <div class="row">
                                    ...
                                    % if sickchill.ALLOW_HIGH_PRIORITY is True:
                                        <div class="field-pair row">
                                            <div class="col-lg-3 col-md-4 col-sm-5 col-xs-12">
                                            ...
                                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                                <input type="checkbox" name="sab_forced" class="enabler"
                                                       id="sab_forced" ${('', 'checked="checked"')[bool(sickchill.SAB_FORCED)]}/>
                                ...
                                <div id="blackhole_settings">
                                    <div class="field-pair row">
                                        ...
                                        <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input type="text" name="nzb_dir" id="nzb_dir" value="${sickchill.NZB_DIR}"
                                                           class="form-control input-sm input350" autocapitalize="off"/>
                                                </div>
                                            </div>
                                            <div class="row">
                                ...
                                <div id="nzbget_settings">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input id="nzbget_use_https" type="checkbox" class="enabler"
                                                           name="nzbget_use_https" ${('', 'checked="checked"')[bool(sickchill.NZBGET_USE_HTTPS)]}/>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input type="text" name="nzbget_host" id="nzbget_host"
                                                           value="${sickchill.NZBGET_HOST}" class="form-control input-sm input350"
                                                           autocapitalize="off"/>
                                                </div>
                                            </div>
                                            <div class="row">
                                    ...
                                    <div class="field-pair row">
                                        ...
                                        <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input type="text" name="nzbget_username" value="${sickchill.NZBGET_USERNAME}"
                                                           class="form-control input-sm input200" autocapitalize="off"
                                    ...
                                    <div class="field-pair row">
                                        ...
                                        <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input
                                                        type="password" name="nzbget_password" id="nzbget_password" value="${sickchill.NZBGET_PASSWORD|hide}"
                                                        class="form-control input-sm input200" autocomplete="no" autocapitalize="off"
                                                    />
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input type="text" name="nzbget_category" id="nzbget_category"
                                                           value="${sickchill.NZBGET_CATEGORY}"
                                                           class="form-control input-sm input200" autocapitalize="off"/>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input type="text" name="nzbget_category_backlog" id="nzbget_category_backlog"
                                                           value="${sickchill.NZBGET_CATEGORY_BACKLOG}"
                                                           class="form-control input-sm input200" autocapitalize="off"/>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input type="text" name="nzbget_category_anime" id="nzbget_category_anime"
                                                           value="${sickchill.NZBGET_CATEGORY_ANIME}"
                                                           class="form-control input-sm input200" autocapitalize="off"/>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input type="text" name="nzbget_category_anime_backlog"
                                                           ...
                                                           value="${sickchill.NZBGET_CATEGORY_ANIME_BACKLOG}"
                                                           class="form-control input-sm input200" autocapitalize="off"/>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <select name="nzbget_priority" id="nzbget_priority" class="form-control input-sm input200">
                                                        <option value="-100" ${('', 'selected="selected"')[sickchill.NZBGET_PRIORITY == -100]}>${_('Very low')}</option>
                                                        <option value="-50" ${('', 'selected="selected"')[sickchill.NZBGET_PRIORITY == -50]}>${_('Low')}</option>
                                                        <option value="0" ${('', 'selected="selected"')[sickchill.NZBGET_PRIORITY == 0]}>${_('Normal')}</option>
                                                        <option value="50" ${('', 'selected="selected"')[sickchill.NZBGET_PRIORITY == 50]}>${_('High')}</option>
                                                        <option value="100" ${('', 'selected="selected"')[sickchill.NZBGET_PRIORITY == 100]}>${_('Very high')}</option>
                                                        <option value="900" ${('', 'selected="selected"')[sickchill.NZBGET_PRIORITY == 900]}>${_('Force')}</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input type="text" name="syno_dsm_host" id="syno_dsm_host"
                                                           value="${sickchill.SYNOLOGY_DSM_HOST}"
                                                           class="form-control input-sm input350" autocapitalize="off"/>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input type="text" name="syno_dsm_user" id="syno_dsm_user"
                                                           value="${sickchill.SYNOLOGY_DSM_USERNAME}"
                                                           class="form-control input-sm input200" autocapitalize="off"
                                                           autocomplete="no"/>
                                                </div>
                                            </div>
                                    ...
                                    <div class="field-pair row">
                                        ...
                                        <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input
                                                        type="password" name="syno_dsm_pass" id="syno_dsm_pass" value="${sickchill.SYNOLOGY_DSM_PASSWORD|hide}"
                                                        class="form-control input-sm input200" autocomplete="no" autocapitalize="off"
                                                    />
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input type="text" name="syno_dsm_path" id="syno_dsm_path"
                                                           value="${sickchill.SYNOLOGY_DSM_PATH}"
                                                           class="form-control input-sm input350" autocapitalize="off"/>
                                                </div>
                                            </div>
                                            <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <div class="component-group-desc">
                            ...
                            <div id="torrent_method_icon" class="add-client-icon-${sickchill.TORRENT_METHOD}"></div>
                        </div>
                    </div>
                    <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="use_torrents" class="enabler"
                                           id="use_torrents" ${('', 'checked="checked"')[bool(sickchill.USE_TORRENTS)]}/>
                                    ...
                                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                        <select name="torrent_method" id="torrent_method" class="form-control input-sm input200" title="torrent_method">
                                            ...
                                            % for curAction in ('blackhole', 'utorrent', 'transmission', 'deluge', 'deluged', 'download_station', 'rtorrent', 'qbittorrent', 'mlnet', 'putio'):
                                                <option value="${curAction}" ${('', 'selected="selected"')[sickchill.TORRENT_METHOD == curAction]}>${torrent_method_text[curAction]}</option>
                                            % endfor
                                        </select>
                                    </div>
                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input type="text" name="torrent_rpcurl" id="torrent_rpcurl"
                                                           value="${sickchill.TORRENT_RPCURL}"
                                                           class="form-control input-sm input350" autocapitalize="off"/>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <select name="torrent_auth_type" id="torrent_auth_type" class="form-control input-sm input150" title="torrent_auth_type">
                                                ...
                                                % for authvalue, authname in six.iteritems(http_authtype):
                                                    <option id="torrent_auth_type_value"
                                                            value="${authvalue}" ${('', 'selected="selected"')[sickchill.TORRENT_AUTH_TYPE == authvalue]}>${authname}</option>
                                                % endfor
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="field-pair row" id="torrent_verify_cert_option">
                                        ...
                                        <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                            <input type="checkbox" name="torrent_verify_cert" class="enabler"
                                                   id="torrent_verify_cert" ${('', 'checked="checked"')[bool(sickchill.TORRENT_VERIFY_CERT)]}/>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input type="text" name="torrent_username" id="torrent_username"
                                                           value="${sickchill.TORRENT_USERNAME}"
                                                           class="form-control input-sm input200" autocapitalize="off"
                                                           autocomplete="no"/>
                                                </div>
                                            </div>
                                    ...
                                    <div class="field-pair row" id="torrent_password_option">
                                        ...
                                        <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input
                                                        type="password" name="torrent_password" id="torrent_password" value="${sickchill.TORRENT_PASSWORD|hide}"
                                                        class="form-control input-sm input200" autocomplete="no" autocapitalize="off"
                                                    />
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input type="text" name="torrent_label_anime" id="torrent_label_anime"
                                                           value="${sickchill.TORRENT_LABEL_ANIME}"
                                                           class="form-control input-sm input200" autocapitalize="off"/>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input type="number" step="1" name="torrent_seed_time" id="torrent_seed_time"
                                                           value="${sickchill.TORRENT_SEED_TIME}" class="form-control input-sm input100"/>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input type="checkbox" name="torrent_paused" class="enabler"
                                                           id="torrent_paused" ${('', 'checked="checked"')[bool(sickchill.TORRENT_PAUSED)]}/>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input type="checkbox" name="torrent_high_bandwidth" class="enabler"
                                                           id="torrent_high_bandwidth" ${('', 'checked="checked"')[bool(sickchill.TORRENT_HIGH_BANDWIDTH)]}/>
