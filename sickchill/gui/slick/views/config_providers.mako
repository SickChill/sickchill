...
<%block name="scripts">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            % if sickchill.USE_NZBS:
                % for curNewznabProvider in sickchill.newznabProviderList:
                ...
                % endfor
            % endif
            % if sickchill.USE_TORRENTS:
                % for curTorrentRssProvider in sickchill.torrentRssProviderList:
            ...
            <div class="row">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <div class="component-group-desc">
                        ...
                        % if not sickchill.USE_NZBS or not sickchill.USE_TORRENTS:
                ...
                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                    ...
                    <fieldset class="component-group-list">
                        ...
                        <ul id="provider_order_list">
                            ...
                            <%
                                if curProvider.provider_type == GenericProvider.NZB and not sickchill.USE_NZBS:
                                    continue
                                elif curProvider.provider_type == GenericProvider.TORRENT and not sickchill.USE_TORRENTS:
                                    continue
                        ...
                        <input type="hidden" name="provider_order" id="provider_order" value="${" ".join([x.get_id(':'+str(int(x.is_enabled))) for x in sickchill.providers.sortedProviderList()])}" />
                    </fieldset>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                    ...
                    <fieldset class="component-group-list">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <%
                                    ...
                                    for curProvider in sickchill.providers.sortedProviderList():
                                        if curProvider.provider_type == GenericProvider.NZB and not (sickchill.USE_NZBS and curProvider.is_enabled):
                                            continue
                                        elif curProvider.provider_type == GenericProvider.TORRENT and not (sickchill.USE_TORRENTS and curProvider.is_enabled):
                                            continue
                        ...
                        % for curNzbProvider in [curProvider for curProvider in sickchill.providers.sortedProviderList() if curProvider.provider_type == GenericProvider.NZB and curProvider not in sickchill.newznabProviderList]:
                        ...
                        % for curTorrentProvider in [curProvider for curProvider in sickchill.providers.sortedProviderList() if curProvider.provider_type == GenericProvider.TORRENT]:
