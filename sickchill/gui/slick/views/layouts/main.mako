...
<html lang="${sickchill.GUI_LANG}">
    <head>
        ...
        <!-- Android -->
        <meta name="theme-color" content="${themeColors[sickchill.THEME_NAME]}">

        <!-- Windows Phone -->
        <meta name="msapplication-navbutton-color" content="${themeColors[sickchill.THEME_NAME]}">
        <!-- iOS -->
        <meta name="apple-mobile-web-app-status-bar-style" content="${themeColors[sickchill.THEME_NAME]}">
        ...
        <meta data-var="srRoot" data-content="${sickchill.WEB_ROOT}">
        <meta data-var="themeSpinner" data-content="${('', '-dark')[sickchill.THEME_NAME == 'dark']}">
        <meta data-var="anonURL" data-content="${sickchill.ANON_REDIRECT}">

        <meta data-var="sickchill.ANIME_SPLIT_HOME" data-content="${sickchill.ANIME_SPLIT_HOME}">
        <meta data-var="sickchill.ANIME_SPLIT_HOME_IN_TABS" data-content="${sickchill.ANIME_SPLIT_HOME_IN_TABS}">
        <meta data-var="sickchill.COMING_EPS_LAYOUT" data-content="${sickchill.COMING_EPS_LAYOUT}">
        <meta data-var="sickchill.COMING_EPS_SORT" data-content="${sickchill.COMING_EPS_SORT}">
        <meta data-var="sickchill.DATE_PRESET" data-content="${sickchill.DATE_PRESET}">
        <meta data-var="sickchill.FUZZY_DATING" data-content="${sickchill.FUZZY_DATING}">
        <meta data-var="sickchill.HISTORY_LAYOUT" data-content="${sickchill.HISTORY_LAYOUT}">
        <meta data-var="sickchill.USE_SUBTITLES" data-content="${sickchill.USE_SUBTITLES}">
        <meta data-var="sickchill.HOME_LAYOUT" data-content="${sickchill.HOME_LAYOUT}">
        <meta data-var="sickchill.POSTER_SORTBY" data-content="${sickchill.POSTER_SORTBY}">
        <meta data-var="sickchill.POSTER_SORTDIR" data-content="${sickchill.POSTER_SORTDIR}">
        <meta data-var="sickchill.ROOT_DIRS" data-content="${sickchill.ROOT_DIRS}">
        <meta data-var="sickchill.SORT_ARTICLE" data-content="${sickchill.SORT_ARTICLE}">
        <meta data-var="sickchill.TIME_PRESET" data-content="${sickchill.TIME_PRESET}">
        <meta data-var="sickchill.TRIM_ZERO" data-content="${sickchill.TRIM_ZERO}">
        <meta data-var="sickchill.SICKCHILL_BACKGROUND" data-content="${sickchill.SICKCHILL_BACKGROUND}">
        <meta data-var="sickchill.FANART_BACKGROUND" data-content="${sickchill.FANART_BACKGROUND}">
        <meta data-var="sickchill.FANART_BACKGROUND_OPACITY" data-content="${sickchill.FANART_BACKGROUND_OPACITY}">
        <%block name="metas" />
        ...
        % if sickchill.THEME_NAME != "light":
            <link rel="stylesheet" type="text/css" href="${static_url(urljoin('css/', '.'.join((sickchill.THEME_NAME, 'css'))))}" />
        % endif

        <%block name="css" />

        % if sickchill.CUSTOM_CSS:
    ...
    <body data-controller="${controller}" data-action="${action}">
        <nav class="navbar navbar-default navbar-fixed-top hidden-print" role="navigation">
            <div class="container-fluid">
                <%
                    numCombined = numErrors + numWarnings + sickchill.NEWS_UNREAD
                    if numCombined:
                        if numErrors:
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li id="NAVhome" class="navbar-split dropdown${('', ' active')[topmenu == 'home']}">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    % if sickchill.SHOWS_RECENT:
                                        <li role="separator" class="divider"></li>
                                        % for recentShow in sickchill.SHOWS_RECENT:
                            ...
                            <%
                                if sickchill.NEWS_UNREAD:
                                    newsBadge = ' <span class="badge">'+str(sickchill.NEWS_UNREAD)+'</span>'
                                else:
                                    newsBadge = ''
                            ...
                            <li id="NAVsystem" class="navbar-split dropdown${('', ' active')[topmenu == 'system']}">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="https://github.com/SickChill/SickChill/wiki/Donations" rel="noreferrer" onclick="window.open('${sickchill.ANON_REDIRECT}' + this.href); return false;"><i class="fa fa-fw fa-life-ring"></i>&nbsp;${_('Support SickChill')}</a></li>
                                    <li role="separator" class="divider"></li>
                                    %if numErrors:
                                    ...
                                    %if numWarnings:
                                        <li>
                                          <a href="${static_url("errorlogs/?level={}".format(sickchill.logger.WARNING), include_version=False)}">
                    ...
                    <div class="footer clearfix col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-12 col-xs-12">
                        ...
                        <div>
                            ...
                            <span class="footer-item">
                             ...
                             <span class="footer-item">${_('Daily Search')}: <span class="footerhighlight">${str(sickchill.dailySearchScheduler.timeLeft()).split('.')[0]}</span></span>&nbsp;|
                             <span class="footer-item">${_('Backlog Search')}: <span class="footerhighlight">${str(sickchill.backlogSearchScheduler.timeLeft()).split('.')[0]}</span></span>
                        </div>
                        ...
                        <div>
                            ...
                            <span class="footer-item">${_('Branch')}: <span class="footerhighlight">${sickchill.BRANCH}</span></span> |
                            <span class="footer-item">${_('Now')}: <span class="footerhighlight">${datetime.datetime.now().strftime(sickchill.DATE_PRESET+" "+sickchill.TIME_PRESET)}</span></span>
                        </div>
                    </div>
                </div>
