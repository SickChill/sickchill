...
<%!
    import re
    import sickchill
    from sickchill.filters import hide
                    ...
                    <fieldset class="component-group-list">
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" class="enabler" name="use_kodi" id="use_kodi" ${('', 'checked="checked"')[bool(sickchill.USE_KODI)]}/>
                        ...
                        <div id="content_use_kodi">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="kodi_always_on" id="kodi_always_on" ${('', 'checked="checked"')[bool(sickchill.KODI_ALWAYS_ON)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="kodi_notify_onsnatch" id="kodi_notify_onsnatch" ${('', 'checked="checked"')[bool(sickchill.KODI_NOTIFY_ONSNATCH)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="kodi_notify_ondownload" id="kodi_notify_ondownload" ${('', 'checked="checked"')[bool(sickchill.KODI_NOTIFY_ONDOWNLOAD)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="kodi_notify_onsubtitledownload" id="kodi_notify_onsubtitledownload" ${('', 'checked="checked"')[bool(sickchill.KODI_NOTIFY_ONSUBTITLEDOWNLOAD)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="kodi_update_library" id="kodi_update_library" ${('', 'checked="checked"')[bool(sickchill.KODI_UPDATE_LIBRARY)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="kodi_update_full" id="kodi_update_full" ${('', 'checked="checked"')[bool(sickchill.KODI_UPDATE_FULL)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="kodi_update_onlyfirst" id="kodi_update_onlyfirst" ${('', 'checked="checked"')[bool(sickchill.KODI_UPDATE_ONLYFIRST)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="kodi_host" id="kodi_host" value="${sickchill.KODI_HOST}" class="form-control input-sm input350" autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="kodi_username" id="kodi_username" value="${sickchill.KODI_USERNAME}" class="form-control input-sm input250" autocapitalize="off" autocomplete="no" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input
                                                type="password" name="kodi_password" id="kodi_password" value="${sickchill.KODI_PASSWORD|hide}"
                ...
                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                    <fieldset class="component-group-list">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" class="enabler" name="use_plex_server" id="use_plex_server" ${('', 'checked="checked"')[bool(sickchill.USE_PLEX_SERVER)]}/>
                        ...
                        <div id="content_use_plex_server">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="plex_server_token" id="plex_server_token" value="${sickchill.PLEX_SERVER_TOKEN}" class="form-control input-sm input350" autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="plex_server_username" id="plex_server_username" value="${sickchill.PLEX_SERVER_USERNAME}" class="form-control input-sm input250" autocapitalize="off" autocomplete="no" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input
                                                ...
                                                value="${sickchill.PLEX_SERVER_PASSWORD|hide}" class="form-control input-sm input250"
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" class="enabler" name="plex_update_library" id="plex_update_library" ${('', 'checked="checked"')[bool(sickchill.PLEX_UPDATE_LIBRARY)]}/>
                            ...
                            <div id="content_plex_update_library">
                                ...
                                <div class="field-pair row">
                                    ...
                                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <input type="text" name="plex_server_host" id="plex_server_host" value="${re.sub(r'\b,\b', ', ', sickchill.PLEX_SERVER_HOST)}" class="form-control input-sm input350" autocapitalize="off" />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                ...
                                <div class="field-pair row">
                                    ...
                                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                        <input type="checkbox" name="plex_server_https" id="plex_server_https" ${('', 'checked="checked"')[bool(sickchill.PLEX_SERVER_HTTPS)]}/>
                ...
                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                    <fieldset class="component-group-list">
                         ...
                         <div class="field-pair row">
                             ...
                             <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                 <input type="checkbox" class="enabler" name="use_plex_client" id="use_plex_client" ${('', 'checked="checked"')[bool(sickchill.USE_PLEX_CLIENT)]}/>
                        ...
                        <div id="content_use_plex_client">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="plex_notify_onsnatch" id="plex_notify_onsnatch" ${('', 'checked="checked"')[bool(sickchill.PLEX_NOTIFY_ONSNATCH)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="plex_notify_ondownload" id="plex_notify_ondownload" ${('', 'checked="checked"')[bool(sickchill.PLEX_NOTIFY_ONDOWNLOAD)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="plex_notify_onsubtitledownload" id="plex_notify_onsubtitledownload" ${('', 'checked="checked"')[bool(sickchill.PLEX_NOTIFY_ONSUBTITLEDOWNLOAD)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="plex_client_host" id="plex_client_host" value="${sickchill.PLEX_CLIENT_HOST}" class="form-control input-sm input350" autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="plex_client_username" id="plex_client_username" value="${sickchill.PLEX_CLIENT_USERNAME}" class="form-control input-sm input250" autocapitalize="off" autocomplete="no" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input
                                                ...
                                                value="${sickchill.PLEX_CLIENT_PASSWORD|hide}" class="form-control input-sm input250"
                                                autocomplete="no" autocapitalize="off"
                                            />
                                        </div>
                                    </div>
                ...
                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                    <fieldset class="component-group-list">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" class="enabler" name="use_emby" id="use_emby" ${('', 'checked="checked"')[bool(sickchill.USE_EMBY)]} />
                        ...
                        <div id="content_use_emby">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="emby_host" id="emby_host" value="${sickchill.EMBY_HOST}" class="form-control input-sm input250" autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="text" name="emby_apikey" id="emby_apikey" value="${sickchill.EMBY_APIKEY}" class="form-control input-sm input250" autocapitalize="off" />
                                </div>
                            </div>
                ...
                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                    <fieldset class="component-group-list">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" class="enabler" name="use_nmj" id="use_nmj" ${('', 'checked="checked"')[bool(sickchill.USE_NMJ)]}/>
                        ...
                        <div id="content_use_nmj">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="nmj_host" id="nmj_host" value="${sickchill.NMJ_HOST}" class="form-control input-sm input250" autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="nmj_database" id="nmj_database" value="${sickchill.NMJ_DATABASE}" class="form-control input-sm input250" ${(' readonly="readonly"', '')[sickchill.NMJ_DATABASE is True]} autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="nmj_mount" id="nmj_mount" value="${sickchill.NMJ_MOUNT}" class="form-control input-sm input250" ${(' readonly="readonly"', '')[sickchill.NMJ_MOUNT is True]} autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                ...
                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                    <fieldset class="component-group-list">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" class="enabler" name="use_nmjv2" id="use_nmjv2" ${('', 'checked="checked"')[bool(sickchill.USE_NMJv2)]}/>
                        ...
                        <div id="content_use_nmjv2">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="nmjv2_host" id="nmjv2_host" value="${sickchill.NMJv2_HOST}" class="form-control input-sm input250" autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="radio" NAME="nmjv2_dbloc" VALUE="local" id="NMJV2_DBLOC_A" ${('', 'checked="checked"')[sickchill.NMJv2_DBLOC == 'local']}/>
                                            <label for="NMJV2_DBLOC_A">PCH Local Media</label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="radio" NAME="nmjv2_dbloc" VALUE="network" id="NMJV2_DBLOC_B" ${('', 'checked="checked"')[sickchill.NMJv2_DBLOC == 'network']}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="nmjv2_database" id="nmjv2_database" value="${sickchill.NMJv2_DATABASE}" class="form-control input-sm input250" ${(' readonly="readonly"', '')[sickchill.NMJv2_DATABASE is True]} autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                    ...
                    <fieldset class="component-group-list">
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="checkbox" class="enabler" name="use_synoindex" id="use_synoindex" ${('', 'checked="checked"')[bool(sickchill.USE_SYNOINDEX)]}/>
                    ...
                    <fieldset class="component-group-list">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="checkbox" class="enabler" name="use_synologynotifier" id="use_synologynotifier" ${('', 'checked="checked"')[bool(sickchill.USE_SYNOLOGYNOTIFIER)]}/>
                        ...
                        <div id="content_use_synologynotifier">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="synologynotifier_notify_onsnatch" id="synologynotifier_notify_onsnatch" ${('', 'checked="checked"')[bool(sickchill.SYNOLOGYNOTIFIER_NOTIFY_ONSNATCH)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="synologynotifier_notify_ondownload" id="synologynotifier_notify_ondownload" ${('', 'checked="checked"')[bool(sickchill.SYNOLOGYNOTIFIER_NOTIFY_ONDOWNLOAD)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="synologynotifier_notify_onsubtitledownload" id="synologynotifier_notify_onsubtitledownload" ${('', 'checked="checked"')[bool(sickchill.SYNOLOGYNOTIFIER_NOTIFY_ONSUBTITLEDOWNLOAD)]}/>
                    ...
                    <fieldset class="component-group-list">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="checkbox" class="enabler" name="use_pytivo" id="use_pytivo" ${('', 'checked="checked"')[bool(sickchill.USE_PYTIVO)]}/>
                        ...
                        <div id="content_use_pytivo">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="pytivo_host" id="pytivo_host" value="${sickchill.PYTIVO_HOST}" class="form-control input-sm input250" autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="pytivo_share_name" id="pytivo_share_name" value="${sickchill.PYTIVO_SHARE_NAME}" class="form-control input-sm input250" autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                             ...
                             <div class="field-pair row">
                                 ...
                                 <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                     <div class="row">
                                         <div class="col-md-12">
                                             <input type="text" name="pytivo_tivo_name" id="pytivo_tivo_name" value="${sickchill.PYTIVO_TIVO_NAME}" class="form-control input-sm input250" autocapitalize="off" />
                                         </div>
                                     </div>
                                     <div class="row">
                                         <div class="col-md-12">
                ...
                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                    <fieldset class="component-group-list">
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" class="enabler" name="use_growl" id="use_growl" ${('', 'checked="checked"')[bool(sickchill.USE_GROWL)]}/>
                        ...
                        <div id="content_use_growl">
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="growl_notify_onsnatch" id="growl_notify_onsnatch" ${('', 'checked="checked"')[bool(sickchill.GROWL_NOTIFY_ONSNATCH)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="growl_notify_ondownload" id="growl_notify_ondownload" ${('', 'checked="checked"')[bool(sickchill.GROWL_NOTIFY_ONDOWNLOAD)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="growl_notify_onsubtitledownload" id="growl_notify_onsubtitledownload" ${('', 'checked="checked"')[bool(sickchill.GROWL_NOTIFY_ONSUBTITLEDOWNLOAD)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="growl_host" id="growl_host" value="${sickchill.GROWL_HOST}" class="form-control input-sm input250" autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input
                                                type="password" name="growl_password" id="growl_password" value="${sickchill.GROWL_PASSWORD|hide}"
                                                class="form-control input-sm input250" autocomplete="no" autocapitalize="off"
                                            />
                                        </div>
                                    </div>
                ...
                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                    ...
                    <fieldset class="component-group-list">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" class="enabler" name="use_prowl" id="use_prowl" ${('', 'checked="checked"')[bool(sickchill.USE_PROWL)]}/>
                        ...
                        <div id="content_use_prowl">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="prowl_notify_onsnatch" id="prowl_notify_onsnatch" ${('', 'checked="checked"')[bool(sickchill.PROWL_NOTIFY_ONSNATCH)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="prowl_notify_ondownload" id="prowl_notify_ondownload" ${('', 'checked="checked"')[bool(sickchill.PROWL_NOTIFY_ONDOWNLOAD)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="prowl_notify_onsubtitledownload" id="prowl_notify_onsubtitledownload" ${('', 'checked="checked"')[bool(sickchill.PROWL_NOTIFY_ONSUBTITLEDOWNLOAD)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="text" name="prowl_message_title" id="prowl_message_title" value="${sickchill.PROWL_MESSAGE_TITLE}" class="form-control input-sm input250" autocapitalize="off" />
                                </div>
                            </div>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="prowl_api" id="prowl_api" value="${sickchill.PROWL_API}" class="form-control input-sm input250" autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <select id="prowl_priority" name="prowl_priority" class="form-control input-sm input250">
                                                <option value="-2" ${('', 'selected="selected"')[sickchill.PROWL_PRIORITY == '-2']}>${_('Very Low')}</option>
                                                <option value="-1" ${('', 'selected="selected"')[sickchill.PROWL_PRIORITY == '-1']}>${_('Moderate')}</option>
                                                <option value="0" ${('', 'selected="selected"')[sickchill.PROWL_PRIORITY == '0']}>${_('Normal')}</option>
                                                <option value="1" ${('', 'selected="selected"')[sickchill.PROWL_PRIORITY == '1']}>${_('High')}</option>
                                                <option value="2" ${('', 'selected="selected"')[sickchill.PROWL_PRIORITY == '2']}>${_('Emergency')}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row">
                ...
                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                    ...
                    <fieldset class="component-group-list">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" class="enabler" name="use_libnotify" id="use_libnotify" ${('', 'checked="checked"')[bool(sickchill.USE_LIBNOTIFY)]}/>
                        ...
                        <div id="content_use_libnotify">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="libnotify_notify_onsnatch" id="libnotify_notify_onsnatch" ${('', 'checked="checked"')[bool(sickchill.LIBNOTIFY_NOTIFY_ONSNATCH)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="libnotify_notify_ondownload" id="libnotify_notify_ondownload" ${('', 'checked="checked"')[bool(sickchill.LIBNOTIFY_NOTIFY_ONDOWNLOAD)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="libnotify_notify_onsubtitledownload" id="libnotify_notify_onsubtitledownload" ${('', 'checked="checked"')[bool(sickchill.LIBNOTIFY_NOTIFY_ONSUBTITLEDOWNLOAD)]}/>
                ...
                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                    ...
                    <fieldset class="component-group-list">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" class="enabler" name="use_pushover" id="use_pushover" ${('', 'checked="checked"')[bool(sickchill.USE_PUSHOVER)]}/>
                        ...
                        <div id="content_use_pushover">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="pushover_notify_onsnatch" id="pushover_notify_onsnatch" ${('', 'checked="checked"')[bool(sickchill.PUSHOVER_NOTIFY_ONSNATCH)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="pushover_notify_ondownload" id="pushover_notify_ondownload" ${('', 'checked="checked"')[bool(sickchill.PUSHOVER_NOTIFY_ONDOWNLOAD)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="pushover_notify_onsubtitledownload" id="pushover_notify_onsubtitledownload" ${('', 'checked="checked"')[bool(sickchill.PUSHOVER_NOTIFY_ONSUBTITLEDOWNLOAD)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="pushover_userkey" id="pushover_userkey" value="${sickchill.PUSHOVER_USERKEY}" class="form-control input-sm input250" autocapitalize="off" autocomplete="no" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="pushover_apikey" id="pushover_apikey" value="${sickchill.PUSHOVER_APIKEY}" class="form-control input-sm input250" autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="pushover_device" id="pushover_device" value="${sickchill.PUSHOVER_DEVICE}" class="form-control input-sm input250" autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <select id="pushover_sound" name="pushover_sound" class="form-control input-sm input250">
                                                <option value="pushover" ${('', 'selected="selected"')[sickchill.PUSHOVER_SOUND == 'pushover']}>${_('Pushover')}</option>
                                                <option value="bike" ${('', 'selected="selected"')[sickchill.PUSHOVER_SOUND == 'bike']}>${_('Bike')}</option>
                                                <option value="bugle" ${('', 'selected="selected"')[sickchill.PUSHOVER_SOUND == 'bugle']}>${_('Bugle')}</option>
                                                <option value="cashregister" ${('', 'selected="selected"')[sickchill.PUSHOVER_SOUND == 'cashregister']}>${_('Cash Register')}</option>
                                                <option value="classical" ${('', 'selected="selected"')[sickchill.PUSHOVER_SOUND == 'classical']}>${_('Classical')}</option>
                                                <option value="cosmic" ${('', 'selected="selected"')[sickchill.PUSHOVER_SOUND == 'cosmic']}>${_('Cosmic')}</option>
                                                <option value="falling" ${('', 'selected="selected"')[sickchill.PUSHOVER_SOUND == 'falling']}>${_('Falling')}</option>
                                                <option value="gamelan" ${('', 'selected="selected"')[sickchill.PUSHOVER_SOUND == 'gamelan']}>${_('Gamelan')}</option>
                                                <option value="incoming" ${('', 'selected="selected"')[sickchill.PUSHOVER_SOUND == 'incoming']}> ${_('Incoming')}</option>
                                                <option value="intermission" ${('', 'selected="selected"')[sickchill.PUSHOVER_SOUND == 'intermission']}>${_('Intermission')}</option>
                                                <option value="magic" ${('', 'selected="selected"')[sickchill.PUSHOVER_SOUND == 'magic']}>${_('Magic')}</option>
                                                <option value="mechanical" ${('', 'selected="selected"')[sickchill.PUSHOVER_SOUND == 'mechanical']}>${_('Mechanical')}</option>
                                                <option value="pianobar" ${('', 'selected="selected"')[sickchill.PUSHOVER_SOUND == 'pianobar']}>${_('Piano Bar')}</option>
                                                <option value="siren" ${('', 'selected="selected"')[sickchill.PUSHOVER_SOUND == 'siren']}>${_('Siren')}</option>
                                                <option value="spacealarm" ${('', 'selected="selected"')[sickchill.PUSHOVER_SOUND == 'spacealarm']}>${_('Space Alarm')}</option>
                                                <option value="tugboat" ${('', 'selected="selected"')[sickchill.PUSHOVER_SOUND == 'tugboat']}>${_('Tug Boat')}</option>
                                                <option value="alien" ${('', 'selected="selected"')[sickchill.PUSHOVER_SOUND == 'alien']}>${_('Alien Alarm (long)')}</option>
                                                <option value="climb" ${('', 'selected="selected"')[sickchill.PUSHOVER_SOUND == 'climb']}>${_('Climb (long)')}</option>
                                                <option value="persistent" ${('', 'selected="selected"')[sickchill.PUSHOVER_SOUND == 'persistent']}>${_('Persistent (long)')}</option>
                                                <option value="echo" ${('', 'selected="selected"')[sickchill.PUSHOVER_SOUND == 'echo']}>${_('Pushover Echo (long)')}</option>
                                                <option value="updown" ${('', 'selected="selected"')[sickchill.PUSHOVER_SOUND == 'updown']}>${_('Up Down (long)')}</option>
                                                <option value="none" ${('', 'selected="selected"')[sickchill.PUSHOVER_SOUND == 'none']}>${_('None (silent)')}</option>
                                                <option value="default" ${('', 'selected="selected"')[sickchill.PUSHOVER_SOUND == 'default']}>${_('Device specific')}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <option value="-2" ${('', 'selected="selected"')[sickchill.PUSHOVER_PRIORITY == '-2']}>${_('Very Low')}</option>
                                            <option value="-1" ${('', 'selected="selected"')[sickchill.PUSHOVER_PRIORITY == '-1']}>${_('Moderate')}</option>
                                            <option value="0" ${('', 'selected="selected"')[sickchill.PUSHOVER_PRIORITY == '0']}>${_('Normal')}</option>
                                            <option value="1" ${('', 'selected="selected"')[sickchill.PUSHOVER_PRIORITY == '1']}>${_('High')}</option>
                                            <option value="2" ${('', 'selected="selected"')[sickchill.PUSHOVER_PRIORITY == '2']}>${_('Emergency')}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row">
                ...
                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                    ...
                    <fieldset class="component-group-list">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" class="enabler" name="use_boxcar2" id="use_boxcar2" ${('', 'checked="checked"')[bool(sickchill.USE_BOXCAR2)]}/>
                        ...
                        <div id="content_use_boxcar2">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="boxcar2_notify_onsnatch" id="boxcar2_notify_onsnatch" ${('', 'checked="checked"')[bool(sickchill.BOXCAR2_NOTIFY_ONSNATCH)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="boxcar2_notify_ondownload" id="boxcar2_notify_ondownload" ${('', 'checked="checked"')[bool(sickchill.BOXCAR2_NOTIFY_ONDOWNLOAD)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="boxcar2_notify_onsubtitledownload" id="boxcar2_notify_onsubtitledownload" ${('', 'checked="checked"')[bool(sickchill.BOXCAR2_NOTIFY_ONSUBTITLEDOWNLOAD)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="boxcar2_accesstoken" id="boxcar2_accesstoken" value="${sickchill.BOXCAR2_ACCESSTOKEN}" class="form-control input-sm input250" autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                ...
                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                    ...
                    <fieldset class="component-group-list">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" class="enabler" name="use_nma" id="use_nma" ${('', 'checked="checked"')[bool(sickchill.USE_NMA)]}/>
                        ...
                        <div id="content_use_nma">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="nma_notify_onsnatch" id="nma_notify_onsnatch" ${('', 'checked="checked"')[bool(sickchill.NMA_NOTIFY_ONSNATCH)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="nma_notify_ondownload" id="nma_notify_ondownload" ${('', 'checked="checked"')[bool(sickchill.NMA_NOTIFY_ONDOWNLOAD)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="nma_notify_onsubtitledownload" id="nma_notify_onsubtitledownload" ${('', 'checked="checked"')[bool(sickchill.NMA_NOTIFY_ONSUBTITLEDOWNLOAD)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="nma_api" id="nma_api" value="${sickchill.NMA_API}" class="form-control input-sm input350" autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <select id="nma_priority" name="nma_priority" class="form-control input-sm input350">
                                                <option value="-2" ${('', 'selected="selected"')[sickchill.NMA_PRIORITY == '-2']}>${_('Very Low')}</option>
                                                <option value="-1" ${('', 'selected="selected"')[sickchill.NMA_PRIORITY == '-1']}>${_('Moderate')}</option>
                                                <option value="0" ${('', 'selected="selected"')[sickchill.NMA_PRIORITY == '0']}>${_('Normal')}</option>
                                                <option value="1" ${('', 'selected="selected"')[sickchill.NMA_PRIORITY == '1']}>${_('High')}</option>
                                                <option value="2" ${('', 'selected="selected"')[sickchill.NMA_PRIORITY == '2']}>${_('Emergency')}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row">
                ...
                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                    ...
                    <fieldset class="component-group-list">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" class="enabler" name="use_pushalot" id="use_pushalot" ${('', 'checked="checked"')[bool(sickchill.USE_PUSHALOT)]}/>
                        ...
                        <div id="content_use_pushalot">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="pushalot_notify_onsnatch" id="pushalot_notify_onsnatch" ${('', 'checked="checked"')[bool(sickchill.PUSHALOT_NOTIFY_ONSNATCH)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="pushalot_notify_ondownload" id="pushalot_notify_ondownload" ${('', 'checked="checked"')[bool(sickchill.PUSHALOT_NOTIFY_ONDOWNLOAD)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="pushalot_notify_onsubtitledownload" id="pushalot_notify_onsubtitledownload" ${('', 'checked="checked"')[bool(sickchill.PUSHALOT_NOTIFY_ONSUBTITLEDOWNLOAD)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="pushalot_authorizationtoken" id="pushalot_authorizationtoken" value="${sickchill.PUSHALOT_AUTHORIZATIONTOKEN}" class="form-control input-sm input350" autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                ...
                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                    ...
                    <fieldset class="component-group-list">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" class="enabler" name="use_pushbullet" id="use_pushbullet" ${('', 'checked="checked"')[bool(sickchill.USE_PUSHBULLET)]}/>
                        ...
                        <div id="content_use_pushbullet">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="pushbullet_notify_onsnatch" id="pushbullet_notify_onsnatch" ${('', 'checked="checked"')[bool(sickchill.PUSHBULLET_NOTIFY_ONSNATCH)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="pushbullet_notify_ondownload" id="pushbullet_notify_ondownload" ${('', 'checked="checked"')[bool(sickchill.PUSHBULLET_NOTIFY_ONDOWNLOAD)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="pushbullet_notify_onsubtitledownload" id="pushbullet_notify_onsubtitledownload" ${('', 'checked="checked"')[bool(sickchill.PUSHBULLET_NOTIFY_ONSUBTITLEDOWNLOAD)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="pushbullet_api" id="pushbullet_api" value="${sickchill.PUSHBULLET_API}" class="form-control input-sm input350" autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="hidden" id="pushbullet_device" value="${sickchill.PUSHBULLET_DEVICE}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="hidden" id="pushbullet_channel" value="${sickchill.PUSHBULLET_CHANNEL}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                    ...
                    <fieldset class="component-group-list">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" class="enabler" name="use_freemobile" id="use_freemobile" ${('', 'checked="checked"')[bool(sickchill.USE_FREEMOBILE)]}/>
                        ...
                        <div id="content_use_freemobile">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="freemobile_notify_onsnatch" id="freemobile_notify_onsnatch" ${('', 'checked="checked"')[bool(sickchill.FREEMOBILE_NOTIFY_ONSNATCH)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="freemobile_notify_ondownload" id="freemobile_notify_ondownload" ${('', 'checked="checked"')[bool(sickchill.FREEMOBILE_NOTIFY_ONDOWNLOAD)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="freemobile_notify_onsubtitledownload" id="freemobile_notify_onsubtitledownload" ${('', 'checked="checked"')[bool(sickchill.FREEMOBILE_NOTIFY_ONSUBTITLEDOWNLOAD)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="freemobile_id" id="freemobile_id" value="${sickchill.FREEMOBILE_ID}" class="form-control input-sm input250" autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="freemobile_apikey" id="freemobile_apikey" value="${sickchill.FREEMOBILE_APIKEY}" class="form-control input-sm input250" autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                ...
                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                    ...
                    <fieldset class="component-group-list">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" class="enabler" name="use_telegram" id="use_telegram" ${('', 'checked="checked"')[bool(sickchill.USE_TELEGRAM)]}/>
                        ...
                        <div id="content_use_telegram">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="telegram_notify_onsnatch" id="telegram_notify_onsnatch" ${('', 'checked="checked"')[bool(sickchill.TELEGRAM_NOTIFY_ONSNATCH)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="telegram_notify_ondownload" id="telegram_notify_ondownload" ${('', 'checked="checked"')[bool(sickchill.TELEGRAM_NOTIFY_ONDOWNLOAD)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="telegram_notify_onsubtitledownload" id="telegram_notify_onsubtitledownload" ${('', 'checked="checked"')[bool(sickchill.TELEGRAM_NOTIFY_ONSUBTITLEDOWNLOAD)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="telegram_id" id="telegram_id" value="${sickchill.TELEGRAM_ID}" class="form-control input-sm input250" autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="telegram_apikey" id="telegram_apikey" value="${sickchill.TELEGRAM_APIKEY}" class="form-control input-sm input250" autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                ...
                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                    ...
                    <fieldset class="component-group-list">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" class="enabler" name="use_join" id="use_join" ${('', 'checked="checked"')[bool(sickchill.USE_JOIN)]}/>
                        ...
                        <div id="content_use_join">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="join_notify_onsnatch" id="telegram_notify_onsnatch" ${('', 'checked="checked"')[bool(sickchill.JOIN_NOTIFY_ONSNATCH)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="join_notify_ondownload" id="join_notify_ondownload" ${('', 'checked="checked"')[bool(sickchill.JOIN_NOTIFY_ONDOWNLOAD)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="join_notify_onsubtitledownload" id="join_notify_onsubtitledownload" ${('', 'checked="checked"')[bool(sickchill.JOIN_NOTIFY_ONSUBTITLEDOWNLOAD)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="join_id" id="join_id" value="${sickchill.JOIN_ID}" class="form-control input-sm input250" autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="join_apikey" id="join_apikey" value="${sickchill.JOIN_APIKEY}" class="form-control input-sm input250" autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                    ...
                    <fieldset class="component-group-list">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="checkbox" class="enabler" name="use_twilio" id="use_twilio" ${('', 'checked="checked"')[bool(sickchill.USE_TWILIO)]}/>
                        ...
                        <div id="content_use_twilio">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="twilio_notify_onsnatch" id="twilio_notify_onsnatch" ${('', 'checked="checked"')[bool(sickchill.TWILIO_NOTIFY_ONSNATCH)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="twilio_notify_ondownload" id="twilio_notify_ondownload" ${('', 'checked="checked"')[bool(sickchill.TWILIO_NOTIFY_ONDOWNLOAD)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="twilio_notify_onsubtitledownload" id="twilio_notify_onsubtitledownload" ${('', 'checked="checked"')[bool(sickchill.TWILIO_NOTIFY_ONSUBTITLEDOWNLOAD)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="twilio_account_sid" id="twilio_account_sid" value="${sickchill.TWILIO_ACCOUNT_SID}" class="form-control input-sm input300" autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="twilio_auth_token" id="twilio_auth_token" value="${sickchill.TWILIO_AUTH_TOKEN}" class="form-control input-sm input300" autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="twilio_phone_sid" id="twilio_phone_sid" value="${sickchill.TWILIO_PHONE_SID}" class="form-control input-sm input300" autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="twilio_to_number" id="twilio_to_number" value="${sickchill.TWILIO_TO_NUMBER}" class="form-control input-sm input200" autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                    ...
                    <fieldset class="component-group-list">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="checkbox" class="enabler" name="use_twitter" id="use_twitter" ${('', 'checked="checked"')[bool(sickchill.USE_TWITTER)]}/>
                        ...
                        <div id="content_use_twitter">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="twitter_notify_onsnatch" id="twitter_notify_onsnatch" ${('', 'checked="checked"')[bool(sickchill.TWITTER_NOTIFY_ONSNATCH)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="twitter_notify_ondownload" id="twitter_notify_ondownload" ${('', 'checked="checked"')[bool(sickchill.TWITTER_NOTIFY_ONDOWNLOAD)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="twitter_notify_onsubtitledownload" id="twitter_notify_onsubtitledownload" ${('', 'checked="checked"')[bool(sickchill.TWITTER_NOTIFY_ONSUBTITLEDOWNLOAD)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="twitter_usedm" id="twitter_usedm" ${('', 'checked="checked"')[bool(sickchill.TWITTER_USEDM)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="twitter_dmto" id="twitter_dmto" value="${sickchill.TWITTER_DMTO}" class="form-control input-sm input250" autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                ...
                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                    <fieldset class="component-group-list">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" class="enabler" name="use_trakt" id="use_trakt" ${('', 'checked="checked"')[bool(sickchill.USE_TRAKT)]}/>
                        ...
                        <div id="content_use_trakt">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="trakt_username" id="trakt_username" value="${sickchill.TRAKT_USERNAME}" class="form-control input-sm input250" autocapitalize="off" autocomplete="no" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="hidden" id="trakt_pin_url" value="${sickchill.TRAKT_PIN_URL}">
                                            <input type="button" class="btn ${('', 'hide')[bool(sickchill.TRAKT_ACCESS_TOKEN)]}" value="${_('Get Trakt PIN')}" id="TraktGetPin" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="number" min="10" step="1" name="trakt_timeout" id="trakt_timeout" value="${sickchill.TRAKT_TIMEOUT}" class="form-control input-sm input75" autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <select id="trakt_default_indexer" name="trakt_default_indexer" class="form-control input-sm input250" title="trakt_default_indexer">
                                        % for indexer in sickchill.indexerApi().indexers:
                                            <option value="${indexer}" ${('', 'selected="selected"')[sickchill.TRAKT_DEFAULT_INDEXER == indexer]}>${sickchill.indexerApi().indexers[indexer]}</option>
                                        % endfor
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" class="enabler" name="trakt_sync" id="trakt_sync" ${('', 'checked="checked"')[bool(sickchill.TRAKT_SYNC)]}/>
                            ...
                            <div id="content_trakt_sync">
                                ...
                                <div class="field-pair row">
                                    ...
                                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                        <input type="checkbox" name="trakt_sync_remove" id="trakt_sync_remove" ${('', 'checked="checked"')[bool(sickchill.TRAKT_SYNC_REMOVE)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="checkbox" class="enabler" name="trakt_sync_watchlist" id="trakt_sync_watchlist" ${('', 'checked="checked"')[bool(sickchill.TRAKT_SYNC_WATCHLIST)]}/>
                            ...
                            <div id="content_trakt_sync_watchlist">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <select id="trakt_method_add" name="trakt_method_add" class="form-control input-sm input250">
                                                    <option value="0" ${('', 'selected="selected"')[sickchill.TRAKT_METHOD_ADD == 0]}>${_('Skip All')}</option>
                                                    <option value="1" ${('', 'selected="selected"')[sickchill.TRAKT_METHOD_ADD == 1]}>${_('Download Pilot Only')}</option>
                                                    <option value="2" ${('', 'selected="selected"')[sickchill.TRAKT_METHOD_ADD == 2]}>${_('Get whole show')}</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="row">
                                ...
                                <div class="field-pair row">
                                    ...
                                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                        <input type="checkbox" name="trakt_remove_watchlist" id="trakt_remove_watchlist" ${('', 'checked="checked"')[bool(sickchill.TRAKT_REMOVE_WATCHLIST)]}/>
                                ...
                                <div class="field-pair row">
                                    ...
                                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                        <input type="checkbox" name="trakt_remove_serieslist" id="trakt_remove_serieslist" ${('', 'checked="checked"')[bool(sickchill.TRAKT_REMOVE_SERIESLIST)]}/>
                                ...
                                <div class="field-pair row">
                                    ...
                                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                        <input type="checkbox" name="trakt_remove_show_from_sickchill" id="trakt_remove_show_from_sickchill" ${('', 'checked="checked"')[bool(sickchill.TRAKT_REMOVE_SHOW_FROM_SICKCHILL)]}/>
                                ...
                                <div class="field-pair row">
                                    ...
                                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                        <input type="checkbox" name="trakt_start_paused" id="trakt_start_paused" ${('', 'checked="checked"')[bool(sickchill.TRAKT_START_PAUSED)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="trakt_blacklist_name" id="trakt_blacklist_name" value="${sickchill.TRAKT_BLACKLIST_NAME}" class="form-control input-sm input250" autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                ...
                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                    <fieldset class="component-group-list">
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" class="enabler" name="use_email" id="use_email" ${('', 'checked="checked"')[bool(sickchill.USE_EMAIL)]}/>
                        ...
                        <div id="content_use_email">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="email_notify_onsnatch" id="email_notify_onsnatch" ${('', 'checked="checked"')[bool(sickchill.EMAIL_NOTIFY_ONSNATCH)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="email_notify_ondownload" id="email_notify_ondownload" ${('', 'checked="checked"')[bool(sickchill.EMAIL_NOTIFY_ONDOWNLOAD)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="email_notify_onsubtitledownload" id="email_notify_onsubtitledownload" ${('', 'checked="checked"')[bool(sickchill.EMAIL_NOTIFY_ONSUBTITLEDOWNLOAD)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="email_host" id="email_host" value="${sickchill.EMAIL_HOST}" class="form-control input-sm input250" autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="number" min="1" step="1" name="email_port" id="email_port" value="${sickchill.EMAIL_PORT}" class="form-control input-sm input75" autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="email_from" id="email_from" value="${sickchill.EMAIL_FROM | h}" class="form-control input-sm input250" autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="email_tls" id="email_tls" ${('', 'checked="checked"')[bool(sickchill.EMAIL_TLS)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="email_user" id="email_user" value="${sickchill.EMAIL_USER}" class="form-control input-sm input250" autocapitalize="off" autocomplete="no" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input
                                                type="password" name="email_password" id="email_password" value="${sickchill.EMAIL_PASSWORD|hide}"
                                                class="form-control input-sm input250" autocomplete="no" autocapitalize="off"
                                            />
                                        </div>
                                    </div>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="email_list" id="email_list" value="${sickchill.EMAIL_LIST}" class="form-control input-sm input350" autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="email_subject" id="email_subject" value="${sickchill.EMAIL_SUBJECT}" class="form-control input-sm input350" autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                    ...
                    <fieldset class="component-group-list">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="checkbox" class="enabler" name="use_slack" id="use_slack" ${('', 'checked="checked"')[bool(sickchill.USE_SLACK)]}/>
                        ...
                        <div id="content_use_slack">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="slack_notify_snatch" id="slack_notify_snatch" ${('', 'checked="checked"')[bool(sickchill.SLACK_NOTIFY_SNATCH)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="slack_notify_download" id="slack_notify_download" ${('', 'checked="checked"')[bool(sickchill.SLACK_NOTIFY_DOWNLOAD)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="text" name="slack_webhook" id="slack_webhook" value="${sickchill.SLACK_WEBHOOK}" class="form-control input-sm input350" autocapitalize="off" />
                                </div>
                            </div>
                    ...
                    <fieldset class="component-group-list">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="checkbox" class="enabler" name="use_discord" id="use_discord" ${('', 'checked="checked"')[bool(sickchill.USE_DISCORD)]}/>
                        ...
                        <div id="content_use_discord">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="discord_notify_snatch" id="discord_notify_snatch" ${('', 'checked="checked"')[bool(sickchill.DISCORD_NOTIFY_SNATCH)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="discord_notify_download" id="discord_notify_download" ${('', 'checked="checked"')[bool(sickchill.DISCORD_NOTIFY_DOWNLOAD)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                  <div class="row">
                                    <div class="col-md-12">
                                      <input type="text" name="discord_webhook" id="discord_webhook" value="${sickchill.DISCORD_WEBHOOK}" class="form-control input-sm input350" autocapitalize="off" />
                                    </div>
                                    <div class="col-md-12">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                  <div class="row">
                                    <div class="col-md-12">
                                      <input type="text" name="discord_name" id="discord_name" value="${sickchill.DISCORD_NAME}" class="form-control input-sm input350" autocapitalize="off" />
                                    </div>
                                    <div class="col-md-12">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                  <div class="row">
                                    <div class="col-md-12">
                                      <input type="text" name="discord_avatar_url" id="discord_avatar_url" value="${sickchill.DISCORD_AVATAR_URL}" class="form-control input-sm input350" autocapitalize="off" />
                                    </div>
                                    <div class="col-md-12">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="discord_tts" id="discord_tts" ${('', 'checked="checked"')[bool(sickchill.DISCORD_TTS)]}/>
