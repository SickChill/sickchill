...
<%block name="content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <a class="btn ${('disabled', '')[sickchill.DOWNLOAD_PROPERS]}" href="${srRoot}/manage/manageSearches/forceFindPropers"><i class="icon-exclamation-sign"></i> ${_('Force')}</a>
            ${(_('Not in progress'), _('In Progress'))[findPropersStatus] if sickchill.DOWNLOAD_PROPERS else _('Propers search disabled')}
        </div>
    </div>
    <br>
    <div class="row">
        <div class="col-md-12">
            ...
            <a class="btn ${('disabled', '')[sickchill.USE_SUBTITLES]}" href="${srRoot}/manage/manageSearches/forceSubtitlesFinder"><i class="icon-exclamation-sign"></i> ${_('Force')}</a>
            ${(_('Not in progress'), _('In Progress'))[subtitlesFinderStatus] if sickchill.USE_SUBTITLES else _('Subtitle search disabled')}
        </div>
    </div>
    <br>
    <div class="row">
