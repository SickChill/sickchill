...
<%!
    ...
    import platform
    import sickchill
    from sickchill.common import MULTI_EP_STRINGS
    from sickchill import naming
                    ...
                    <fieldset class="component-group-list">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="checkbox" name="process_automatically" id="process_automatically" ${('', 'checked="checked"')[bool(sickchill.PROCESS_AUTOMATICALLY)]}/>
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="text" name="tv_download_dir" id="tv_download_dir" value="${sickchill.TV_DOWNLOAD_DIR}" class="form-control input-sm input350" autocapitalize="off" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <select name="process_method" id="process_method" class="form-control input-sm input350" title="process_method">
                                            ...
                                            % for curAction in ('copy', 'move', 'hardlink', 'symlink', 'symlink_reversed'):
                                                <option value="${curAction}" ${('', 'selected="selected"')[sickchill.PROCESS_METHOD == curAction]}>${process_method_text[curAction]}</option>
                                            % endfor
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="number" min="10" step="1" name="autopostprocessor_frequency" id="autopostprocessor_frequency" value="${sickchill.AUTOPOSTPROCESSOR_FREQUENCY}" class="form-control input-sm input75" title="autopostprocessor_frequency"/>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                <input type="checkbox" name="postpone_if_sync_files" id="postpone_if_sync_files" ${('', 'checked="checked"')[bool(sickchill.POSTPONE_IF_SYNC_FILES)]}/>
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="text" name="sync_files" id="sync_files" value="${sickchill.SYNC_FILES}" class="form-control input-sm input350" autocapitalize="off" title="sync_files"/>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                <input type="checkbox" name="rename_episodes" id="rename_episodes" ${('', 'checked="checked"')[bool(sickchill.RENAME_EPISODES)]}/>
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                <input type="checkbox" name="create_missing_show_dirs" id="create_missing_show_dirs" ${('', 'checked="checked"')[bool(sickchill.CREATE_MISSING_SHOW_DIRS)]}/>
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                <input type="checkbox" name="add_shows_wo_dir" id="add_shows_wo_dir" ${('', 'checked="checked"')[bool(sickchill.ADD_SHOWS_WO_DIR)]}/>
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                <input type="checkbox" class="enabler" name="move_associated_files" id="move_associated_files" ${('', 'checked="checked"')[bool(sickchill.MOVE_ASSOCIATED_FILES)]}/>
                        ...
                        <div class="field-pair row" id="content_move_associated_files">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                <input type="checkbox" name="nfo_rename" id="nfo_rename" ${('', 'checked="checked"')[bool(sickchill.NFO_RENAME)]}/>
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="text" name="allowed_extensions" id="allowed_extensions" value="${sickchill.ALLOWED_EXTENSIONS}" class="form-control input-sm input350" autocapitalize="off" />
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                <input type="checkbox" name="delete_non_associated_files" id="delete_non_associated_files" ${('', 'checked="checked"')[bool(sickchill.DELETE_NON_ASSOCIATED_FILES)]}/>
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="checkbox" name="airdate_episodes" id="airdate_episodes" ${('', 'checked="checked"')[bool(sickchill.AIRDATE_EPISODES)]}/>
                                    ...
                                    <div class="col-md-12">
                                        <select name="file_timestamp_timezone" id="file_timestamp_timezone" class="form-control input-sm input350">
                                            % for curTimezone in (_('local'), _('network')):
                                                <option value="${curTimezone}" ${('', 'selected="selected"')[sickchill.FILE_TIMESTAMP_TIMEZONE == curTimezone]}>${curTimezone}</option>
                                            % endfor
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <select name="unpack" id="unpack" class="form-control input-sm input350" title="unpack">
                                                <option value="0" ${('', 'selected="selected"')[int(sickchill.UNPACK) == 0]}>
                                                    ${_('Ignore (do not process contents)')}
                                                </option>
                                                <option value="1" ${('', 'selected="selected"')[int(sickchill.UNPACK) == 1]}>
                                                    ${_('Unpack (process contents)')}
                                                </option>
                                                <option value="2" ${('', 'selected="selected"')[int(sickchill.UNPACK) == 2]}>
                            ...
                            <div id="content_unpack">
                                <div class="field-pair row">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <input type="text" name="unpack_dir" id="unpack_dir" value="${sickchill.UNPACK_DIR}" class="form-control
                                ...
                                <div class="field-pair row">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <input type="text" name="unrar_tool" id="unrar_tool" value="${sickchill.UNRAR_TOOL}" class="form-control
                                                input-sm input350" autocapitalize="off" />
                                            </div>
                                        </div>
                                        <div class="row">
                                ...
                                <div class="field-pair row">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <input type="text" name="alt_unrar_tool" id="alt_unrar_tool" value="${sickchill.ALT_UNRAR_TOOL}" class="form-control
                                                input-sm input350" autocapitalize="off" />
                                            </div>
                                        </div>
                                        <div class="row">
                                ...
                                <div class="field-pair row">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <input type="checkbox" name="del_rar_contents" id="del_rar_contents" ${('', 'checked="checked"')[bool(sickchill.DELRARCONTENTS)]}/>
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="checkbox" name="no_delete" id="no_delete" ${('', 'checked="checked"')[bool(sickchill.NO_DELETE)]}/>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="checkbox" name="processor_follow_symlinks" id="processor_follow_symlinks"
                                            ${('', 'checked="checked"')[bool(sickchill.PROCESSOR_FOLLOW_SYMLINKS)]}/>
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="checkbox" name="use_icacls" id="use_icacls" ${('', 'checked="checked"')[bool(sickchill.USE_ICACLS)]}/>
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="text" name="extra_scripts" value="${'|'.join(sickchill.EXTRA_SCRIPTS)}" class="form-control input-sm input350" autocapitalize="off"  title="extra_script"/>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                    ...
                    <fieldset class="component-group-list">
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                <select id="name_presets" class="form-control input-sm input350" title="name_presets">
                                    ...
                                    % if cur_preset == sickchill.NAMING_PATTERN:
                                        <% is_custom = False %>
                                    % endif
                                        <option id="${cur_preset}" ${('', 'selected="selected"')[sickchill.NAMING_PATTERN == cur_preset]}>${ek(os.path.join, tmp['dir'], tmp['name'])}</option>
                                    % endfor
                                    <option id="${sickchill.NAMING_PATTERN}" ${('', 'selected="selected"')[bool(is_custom)]}>Custom...</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div id="content_name_presets">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="naming_pattern" id="naming_pattern" value="${sickchill.NAMING_PATTERN}" class="form-control input-sm input350" autocapitalize="off" title="naming_pattern"/>
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                <select id="naming_multi_ep" name="naming_multi_ep" class="form-control input-sm input350" title="naming_multi_ep">
                                    % for cur_multi_ep in sorted(six.iteritems(MULTI_EP_STRINGS), key=lambda x: x[1]):
                                        <option value="${cur_multi_ep[0]}" ${('', 'selected="selected"')[cur_multi_ep[0] == sickchill.NAMING_MULTI_EP]}>${cur_multi_ep[1]}</option>
                                    % endfor
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="checkbox" id="naming_strip_year"  name="naming_strip_year" ${('', 'checked="checked"')[bool(sickchill.NAMING_STRIP_YEAR)]}/>
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                <input type="checkbox" class="enabler" id="naming_custom_abd" name="naming_custom_abd" ${('', 'checked="checked"')[bool(sickchill.NAMING_CUSTOM_ABD)]}/>
                        ...
                        <div id="content_naming_custom_abd">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                    <select id="name_abd_presets" class="form-control input-sm input350" title="name_adb_presets">
                                        ...
                                        % if cur_preset == sickchill.NAMING_ABD_PATTERN:
                                            <% is_abd_custom = False %>
                                        % endif
                                            <option id="${cur_preset}" ${('', 'selected="selected"')[sickchill.NAMING_ABD_PATTERN == cur_preset]}>${ek(os.path.join, tmp['dir'], tmp['name'])}</option>
                                        % endfor
                                        <option id="${sickchill.NAMING_ABD_PATTERN}" ${('', 'selected="selected"')[bool(is_abd_custom)]}>Custom...</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div id="naming_abd_custom">
                                ...
                                <div class="field-pair row">
                                    <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12"></div>
                                    <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                        <input type="text" name="naming_abd_pattern" id="naming_abd_pattern" value="${sickchill.NAMING_ABD_PATTERN}"
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                <input type="checkbox" class="enabler" id="naming_custom_sports" name="naming_custom_sports" ${('', 'checked="checked"')[bool(sickchill.NAMING_CUSTOM_SPORTS)]}/>
                        ...
                        <div id="content_naming_custom_sports">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                    <select id="name_sports_presets" class="form-control input-sm input350" title="name_sports_presets">
                                        ...
                                        <% tmp = naming.test_name(cur_preset) %>
                                        % if cur_preset == sickchill.NAMING_SPORTS_PATTERN:
                                            <% is_sports_custom = False %>
                                        % endif
                                            <option id="${cur_preset}" ${('', 'selected="selected"')[sickchill.NAMING_SPORTS_PATTERN == cur_preset]}>${ek(os.path.join, tmp['dir'], tmp['name'])}</option>
                                        % endfor
                                        <option id="${sickchill.NAMING_SPORTS_PATTERN}" ${('', 'selected="selected"')[bool(is_sports_custom)]}>Custom...</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div id="naming_sports_custom">
                                ...
                                <div class="field-pair row">
                                    <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12"></div>
                                    <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                        <input type="text" name="naming_sports_pattern" id="naming_sports_pattern" value="${sickchill.NAMING_SPORTS_PATTERN}"
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                <input type="checkbox" class="enabler" id="naming_custom_anime" name="naming_custom_anime" ${('', 'checked="checked"')[bool(sickchill.NAMING_CUSTOM_ANIME)]}/>
                        ...
                        <div id="content_naming_custom_anime">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                    <select id="name_anime_presets" class="form-control input-sm input350">
                                        ...
                                        <% tmp = naming.test_name(cur_preset) %>
                                        % if cur_preset == sickchill.NAMING_ANIME_PATTERN:
                                            <% is_anime_custom = False %>
                                        % endif
                                            <option id="${cur_preset}" ${('', 'selected="selected"')[cur_preset == sickchill.NAMING_ANIME_PATTERN]}>${ek(os.path.join, tmp['dir'], tmp['name'])}</option>
                                        % endfor
                                        <option id="${sickchill.NAMING_ANIME_PATTERN}" ${('', 'selected="selected"')[bool(is_anime_custom)]}>Custom...</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div id="naming_anime_custom">
                                ...
                                <div class="field-pair row">
                                    <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12"></div>
                                    <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                        <input type="text" name="naming_anime_pattern" id="naming_anime_pattern" value="${sickchill.NAMING_ANIME_PATTERN}"
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                    <select id="naming_anime_multi_ep" name="naming_anime_multi_ep" class="form-control input-sm input350" title="naming_anime_multi_ep">
                                        % for cur_multi_ep in sorted(six.iteritems(MULTI_EP_STRINGS), key=lambda x: x[1]):
                                            <option value="${cur_multi_ep[0]}" ${('', 'selected="selected" class="selected"')[cur_multi_ep[0] == sickchill.NAMING_ANIME_MULTI_EP]}>${cur_multi_ep[1]}</option>
                                        % endfor
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="radio" name="naming_anime" id="naming_anime" value="1" ${('', 'checked="checked"')[sickchill.NAMING_ANIME == 1]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="radio" name="naming_anime" id="naming_anime_only" value="2" ${('', 'checked="checked"')[sickchill.NAMING_ANIME == 2]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="radio" name="naming_anime" id="naming_anime_none" value="3" ${('', 'checked="checked"')[sickchill.NAMING_ANIME in (3, None)]}/>
                ...
                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                    ...
                    <fieldset class="component-group-list">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <select id="metadataType" class="form-control input-sm input350">
                                            % for (cur_name, cur_generator) in sorted(six.iteritems(sickchill.metadata_provider_dict)):
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                % for (cur_name, cur_generator) in six.iteritems(sickchill.metadata_provider_dict):
                                    <%
                                        cur_metadata_inst = sickchill.metadata_provider_dict[cur_generator.name]
