                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                <input type="checkbox" class="enabler" name="use_anidb"
                                       id="use_anidb" ${('', 'checked="checked"')[bool(sickchill.USE_ANIDB)]} />
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="anidb_username" id="anidb_username"
                                                   value="${sickchill.ANIDB_USERNAME}"
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input
                                                type="password" name="anidb_password" id="anidb_password" value="${sickchill.ANIDB_PASSWORD|hide}"
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 component-desc">
                                    <input type="checkbox" name="anidb_use_mylist"
                                           id="anidb_use_mylist" ${('', 'checked="checked"')[bool(sickchill.ANIDB_USE_MYLIST)]}/>
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                <input type="checkbox" class="enabler" name="split_home"
                                       id="split_home" ${('', 'checked="checked"')[bool(sickchill.ANIME_SPLIT_HOME)]} title="Split"/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right component-desc">
                                    <input type="checkbox" name="split_home_in_tabs"
                                           id="split_home_in_tabs" ${('', 'checked="checked"')[bool(sickchill.ANIME_SPLIT_HOME_IN_TABS)]} title="Split in tabs"/>
