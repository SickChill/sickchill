                ...
                <div class="col-md-12">
                    ...
                    <select name="newStatus" class="form-control form-control-inline input-sm" title="newStatus">
                        <%
                            ...
                            if int(whichStatus) in [common.SNATCHED, common.SNATCHED_PROPER, common.SNATCHED_BEST] + common.Quality.ARCHIVED + common.Quality.DOWNLOADED and sickchill.USE_FAILED_DOWNLOADS:
