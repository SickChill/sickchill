...
<%!
    ...
    import urllib
    import sickchill
    from sickchill import subtitles, sbdatetime, network_timezones
    import sickchill.helpers

    from sickchill.common import SKIPPED, WANTED, UNAIRED, ARCHIVED, IGNORED, FAILED, DOWNLOADED
    from sickchill.common import Quality, qualityPresets, statusStrings, Overview
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="showtitle" data-showname="${show.name}">
                    ...
                    % if seasonResults:
                        ...
                        % if not sickchill.DISPLAY_SHOW_SPECIALS and season_special:
                    ...
                    <div class="info-container">
                        <div class="row">
                            ...
                            <div class="pull-left col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                ...
                                % endif
                                <a href="${anon_url(sickchill.indexerApi(_show.indexer).config['show_url'], _show.indexerid)}" onclick="window.open(this.href, '_blank'); return false;" title="${sickchill.indexerApi(show.indexer).config["show_url"] + str(show.indexerid)}"><img alt="${sickchill.indexerApi(show.indexer).name}" src="${static_url('images/indexers/' + sickchill.indexerApi(show.indexer).config["icon"])}" style="margin-top: -1px; vertical-align:middle;"/></a>
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                        ...
                                        <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>${pretty_file_size(sickchill.helpers.get_size(showLoc[0]))}</td>
                                            </tr>
                                        </table>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 pull-xs-left">
                                        <table class="pull-xs-left pull-md-right pull-sm-right pull-lg-right">
                                            ...
                                            <tr>
                                                ...
                                                <td><span class="displayshow-icon-${("disable", "enable")[bool(show.season_folders or sickchill.NAMING_FORCE_FOLDERS)]}" title=${("N", "Y")[bool(show.season_folders or sickchill.NAMING_FORCE_FOLDERS)]}></span></td>
                                            </tr>
                                            <tr>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-bottom: 5px; padding-top: 5px;">
                    ...
                    <select id="statusSelect" class="form-control form-control-inline input-sm" title="Change Status">
                        ...
                        % if not sickchill.USE_FAILED_DOWNLOADS:
        ...
        <div class="col-md-12">
            ...
            % for epResult in sql_results:
                <%
                    ...
                    if not sickchill.DISPLAY_SHOW_SPECIALS and int(epResult[b"season"]) == 0:
                        continue
                ...
                % if int(epResult[b"season"]) != curSeason:
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            % if not sickchill.DISPLAY_ALL_SEASONS:
                                % if curSeason == -1:
                                ...
                                <table id="${("showTable", "animeTable")[bool(show.is_anime)]}" class="displayShowTable display_show" cellspacing="0" border="0" cellpadding="0">
                                    <thead>
                                        <tr class="seasoncols">
                                            ...
                                            <th data-sorter="false" ${("class=\"col-ep columnSelector-false\"", "class=\"col-ep\"")[bool(sickchill.DOWNLOAD_URL)]}>${_('Download')}</th>
                                            <th data-sorter="false" ${("class=\"col-ep columnSelector-false\"", "class=\"col-ep\"")[bool(sickchill.USE_SUBTITLES)]}>${_('Subtitles')}</th>
                ...
                % endif
                                    <tr class="${Overview.overviewStrings[epCats[epStr]]} season-${curSeason} seasonstyle" id="${'S' + str(epResult[b"season"]) + 'E' + str(epResult[b"episode"])}">
                                        ...
                                        <td>
                                            % if sickchill.DOWNLOAD_URL and epResult[b'location']:
                                            <%
                                                filename = epResult[b'location']
                                                for rootDir in sickchill.ROOT_DIRS.split('|'):
                                                    if rootDir.startswith('/'):
                                                        filename = filename.replace(rootDir, "")
                                                filename = sickchill.DOWNLOAD_URL + urllib.quote(filename.encode('utf8'))
                                            %>
                                        ...
                                        <td class="col-search">
                                            % if int(epResult[b"season"]) != 0:
                                                % if (int(epResult[b"status"]) in Quality.SNATCHED + Quality.SNATCHED_PROPER + Quality.SNATCHED_BEST + Quality.DOWNLOADED ) and sickchill.USE_FAILED_DOWNLOADS:
                                                ...
                                                % endif
                                            % endif
                                            % if int(epResult[b"status"]) not in Quality.SNATCHED + Quality.SNATCHED_PROPER and sickchill.USE_SUBTITLES and show.subtitles and epResult[b"location"] and subtitles.needs_subtitles(epResult['subtitles']):
                                                % if int(epResult[b"season"]) != 0 or sickchill.SUBTITLES_INCLUDE_SPECIALS:
