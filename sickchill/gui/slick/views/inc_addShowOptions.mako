<%
    import sickchill
    from sickchill.common import SKIPPED, WANTED, IGNORED
    from sickchill.common import Quality, statusStrings
%>
    <div class="field-pair row">
        ...
        <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
            <% anyQualities, bestQualities = Quality.splitQuality(sickchill.QUALITY_DEFAULT) %>
    ...
    % if sickchill.USE_SUBTITLES:
        <div class="field-pair row">
            ...
            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                <input type="checkbox" name="subtitles" id="subtitles" ${('', 'checked="checked"')[bool(sickchill.SUBTITLES_DEFAULT)]} />
        ...
        <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
            <select name="defaultStatus" id="statusSelect" class="form-control form-control-inline input-sm" title="defaultStatus">
                % for curStatus in [SKIPPED, WANTED, IGNORED]:
                    <option value="${curStatus}" ${('', 'selected="selected"')[sickchill.STATUS_DEFAULT == curStatus]}>${statusStrings[curStatus]}</option>
                % endfor
            </select>
        </div>
    </div>
    ...
    <div class="field-pair row">
        ...
        <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
            <select name="defaultStatusAfter" id="statusSelectAfter" class="form-control form-control-inline input-sm">
                % for curStatus in [SKIPPED, WANTED, IGNORED]:
                    <option value="${curStatus}" ${('', 'selected="selected"')[sickchill.STATUS_DEFAULT_AFTER == curStatus]}>${statusStrings[curStatus]}</option>
                % endfor
            </select>
        </div>
    </div>
    ...
    <div class="field-pair row">
        ...
        <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
            <input type="checkbox" name="season_folders" id="season_folders" ${('', 'checked="checked"')[bool(sickchill.SEASON_FOLDERS_DEFAULT)]}/>
    ...
    % if enable_anime_options:
        <div class="field-pair row">
            ...
            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                <input type="checkbox" name="anime" id="anime" ${('', 'checked="checked"')[bool(sickchill.ANIME_DEFAULT)]} />
    ...
    <div class="field-pair row">
        ...
        <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
            <input type="checkbox" name="scene" id="scene" ${('', 'checked="checked"')[bool(sickchill.SCENE_DEFAULT)]} />
    ...
    % if enable_anime_options:
        <% import sickchill.blackandwhitelist %>
