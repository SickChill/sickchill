            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                    <div class="row">
                        <div class="col-md-12">
                            Branch:
                            <a href="${anon_url('https://github.com/SickChill/SickChill/tree/%s' % sickchill.BRANCH)}">
                                ${sickchill.BRANCH}
                            </a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            Commit:
                            <a href="${anon_url('https://github.com/SickChill/SickChill/commit/%s' % sickchill.CUR_COMMIT_HASH)}">
                                ${sickchill.CUR_COMMIT_HASH}
                            </a>
                        </div>
                    </div>
                    % if sr_version:
