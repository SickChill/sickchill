...
<%!
    ...
    import sickchill
    from sickchill.common import SKIPPED, ARCHIVED, IGNORED, statusStrings, cpu_presets
    from sickchill.filters import hide
    from sickchill.sbdatetime import sbdatetime, date_presets, time_presets
    from sickchill.helpers import anon_url, LOCALE_NAMES
                    ...
                    <fieldset class="component-group-list">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <select name="indexerDefaultLang" id="indexerDefaultLang" class="form-control form-control-inline input-sm input350 bfh-languages" data-language=${sickchill.INDEXER_DEFAULT_LANGUAGE} data-available="${','.join(sickchill.indexerApi().config['valid_languages'])}"></select>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" name="launch_browser" id="launch_browser" ${('', 'checked="checked"')[bool(sickchill.LAUNCH_BROWSER)]}/>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <select id="default_page" name="default_page" class="form-control input-sm input150">
                                            <option value="home" ${('', 'selected="selected"')[sickchill.DEFAULT_PAGE == 'home']}>${_('Shows')}</option>
                                            <option value="schedule" ${('', 'selected="selected"')[sickchill.DEFAULT_PAGE == 'schedule']}>${_('Schedule')}</option>
                                            <option value="history" ${('', 'selected="selected"')[sickchill.DEFAULT_PAGE == 'history']}>${_('History')}</option>
                                            <option value="news" ${('', 'selected="selected"')[sickchill.DEFAULT_PAGE == 'news']}>${_('News')}</option>
                                            <option value="IRC" ${('', 'selected="selected"')[sickchill.DEFAULT_PAGE == 'IRC']}>${_('IRC')}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="number" min="0" max="23" step="1" name="showupdate_hour" id="showupdate_hour" value="${sickchill.SHOWUPDATE_HOUR}" class="form-control input-sm input75" autocapitalize="off" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="checkbox" name="trash_remove_show" id="trash_remove_show" ${('', 'checked="checked"')[bool(sickchill.TRASH_REMOVE_SHOW)]}/>
                                        <label for="trash_remove_show">${_('when using show "Remove" and delete files')}</label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="checkbox" name="trash_rotate_logs" id="trash_rotate_logs" ${('', 'checked="checked"')[bool(sickchill.TRASH_ROTATE_LOGS)]}/>
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="text" name="log_dir" id="log_dir" value="${sickchill.ACTUAL_LOG_DIR}" class="form-control input-sm input250" autocapitalize="off"  title="log_dir"/>
                            </div>
                        </div>
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="number" min="1" step="1" name="log_nr" id="log_nr" value="${sickchill.LOG_NR}" class="form-control input-sm input75" autocapitalize="off" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="number" min="0.5" step="0.1" name="log_size" id="log_size" value="${sickchill.LOG_SIZE}" class="form-control input-sm input75" autocapitalize="off" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <select id="indexer_default" name="indexer_default" class="form-control input-sm input150">
                                            <option value="0" ${('', 'selected="selected"')[sickchill.INDEXER_DEFAULT == 0]}>${_('All Indexers')}</option>
                                            % for indexer in sickchill.indexerApi().indexers:
                                                <option value="${indexer}" ${('', 'selected="selected"')[sickchill.INDEXER_DEFAULT == indexer]}>${sickchill.indexerApi().indexers[indexer]}</option>
                                            % endfor
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="number" min="10" step="1" name="indexer_timeout" id="indexer_timeout" value="${sickchill.INDEXER_TIMEOUT}" class="form-control input-sm input75" autocapitalize="off" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                ...
                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                    <fieldset class="component-group-list">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" name="version_notify" id="version_notify" ${('', 'checked="checked"')[bool(sickchill.VERSION_NOTIFY)]}/>
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" name="auto_update" id="auto_update" ${('', 'checked="checked"')[bool(sickchill.AUTO_UPDATE)]}/>
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="number" min="1" step="1" name="update_frequency" id="update_frequency" value="${sickchill.UPDATE_FREQUENCY}" class="form-control input-sm input75" autocapitalize="off" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" name="notify_on_update" id="notify_on_update" ${('', 'checked="checked"')[bool(sickchill.NOTIFY_ON_UPDATE)]}/>
                ...
                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                    ...
                    <fieldset class="component-group-list">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <select id="gui_language" name="gui_language" class="form-control input-sm input250">
                                            <option value="" ${('', 'selected="selected"')[sickchill.GUI_LANG == ""]}>${_('System Language')}</option>
                                            % for lang in [language for language in os.listdir(sickchill.LOCALE_DIR) if '_' in language]:
                                                <option value="${lang}" ${('', 'selected="selected"')[sickchill.GUI_LANG == lang]}>${lang_name(lang)}</option>
                                            % endfor
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <select id="theme_name" name="theme_name" class="form-control input-sm input250">
                                            <option value="dark" ${('', 'selected="selected"')[sickchill.THEME_NAME == 'dark']}>${_('Dark')}</option>
                                            <option value="light" ${('', 'selected="selected"')[sickchill.THEME_NAME == 'light']}>${_('Light')}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" class="enabler" name="sickchill_background" id="sickchill_background"
                                    ${('', 'checked="checked"')[bool(sickchill.SICKCHILL_BACKGROUND)]} />
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="sickchill_background_path" id="sickchill_background_path"
                                                   value="${sickchill.SICKCHILL_BACKGROUND_PATH}" class="form-control input-sm input350" autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" class="enabler" name="fanart_background" id="fanart_background" ${('', 'checked="checked"')[bool(sickchill.FANART_BACKGROUND)]}>
                        ...
                        <div id="content_fanart_background">
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="number" step="0.1" min="0.1" max="1.0" name="fanart_background_opacity" id="fanart_background_opacity" value="${sickchill.FANART_BACKGROUND_OPACITY}" class="form-control input-sm input75" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" class="enabler" name="custom_css" id="custom_css"
                                    ${('', 'checked="checked"')[bool(sickchill.CUSTOM_CSS)]} />
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="custom_css_path" id="custom_css_path"
                                                   value="${sickchill.CUSTOM_CSS_PATH}" class="form-control input-sm input350" autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" name="display_all_seasons" id="display_all_seasons" ${('', 'checked="checked"')[bool(sickchill.DISPLAY_ALL_SEASONS)]}>
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" name="sort_article" id="sort_article" ${('', 'checked="checked"')[bool(sickchill.SORT_ARTICLE)]}/>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="number" step="1" min="0" max="42810" name="coming_eps_missed_range" id="coming_eps_missed_range"
                                               value="${sickchill.COMING_EPS_MISSED_RANGE}" class="form-control input-sm input75" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" name="fuzzy_dating" id="fuzzy_dating" class="viewIf datePresets" ${('', 'checked="checked"')[bool(sickchill.FUZZY_DATING)]}/>
                                <label for="fuzzy_dating">${_('move absolute dates into tooltips and display e.g. "Last Thu", "On Tue"')}</label>
                            </div>
                        </div>

                        <div class="field-pair row show_if_fuzzy_dating ${(' metadataDiv', '')[not bool(sickchill.FUZZY_DATING)]}">
                            <div class="col-lg-3 col-md-4 col-sm-5 col-xs-12">
                                <label class="component-title">${_('Trim zero padding')}</label>
                            </div>
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" name="trim_zero" id="trim_zero" ${('', 'checked="checked"')[bool(sickchill.TRIM_ZERO)]}/>
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <select class="form-control input-sm input250 ${(' metadataDiv', '')[bool(sickchill.FUZZY_DATING)]}" id="date_presets${('_na', '')[bool(sickchill.FUZZY_DATING)]}" name="date_preset${('_na', '')[bool(sickchill.FUZZY_DATING)]}">
                                    % for cur_preset in date_presets:
                                        <option value="${cur_preset}" ${('', 'selected="selected"')[sickchill.DATE_PRESET == cur_preset or ("%x" == sickchill.DATE_PRESET and cur_preset == '%a, %b %d, %Y')]}>${datetime.datetime(datetime.datetime.now().year, 12, 31, 14, 30, 47).strftime(cur_preset)}</option>
                                    % endfor
                                </select>
                                <select class="form-control input-sm input250 ${(' metadataDiv', '')[not bool(sickchill.FUZZY_DATING)]}" id="date_presets${(' metadataDiv', '')[not bool(sickchill.FUZZY_DATING)]}" name="date_preset${('_na', '')[not bool(sickchill.FUZZY_DATING)]}">
                                    <option value="%x" ${('', 'selected="selected"')[sickchill.DATE_PRESET == '%x']}>${_('Use System Default')}</option>
                                    % for cur_preset in date_presets:
                                        <option value="${cur_preset}" ${('', 'selected="selected"')[sickchill.DATE_PRESET == cur_preset]}>${datetime.datetime(datetime.datetime.now().year, 12, 31, 14, 30, 47).strftime(cur_preset)}</option>
                                    % endfor
                                </select>
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <select id="time_presets" name="time_preset" class="form-control input-sm input250">
                                            % for cur_preset in time_presets:
                                                <option value="${cur_preset}" ${('', 'selected="selected"')[sickchill.TIME_PRESET_W_SECONDS == cur_preset]}>${sbdatetime.now().sbftime(show_seconds=True, t_preset=cur_preset)}</option>
                                            % endfor
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input style="margin-top: 2px !important;" type="radio" name="timezone_display" id="local" value="local" ${('', 'checked="checked"')[sickchill.TIMEZONE_DISPLAY == "local"]} >
                                        <label for="local" class="space-right">${_('Local')}</label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <input style="margin-top: 2px !important;" type="radio" name="timezone_display" id="network" value="network" ${('', 'checked="checked"')[sickchill.TIMEZONE_DISPLAY == "network"]} />
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input class="form-control input350" type="text" name="download_url" id="download_url" value="${sickchill.DOWNLOAD_URL}" size="35" autocapitalize="off" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                    ...
                    <fieldset class="component-group-list">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="text" name="api_key" id="api_key" value="${sickchill.API_KEY}" class="form-control input-sm input300" readonly="readonly" autocapitalize="off" />
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" name="web_log" id="web_log" ${('', 'checked="checked"')[bool(sickchill.WEB_LOG)]}/>
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="text" name="web_username" id="web_username" value="${sickchill.WEB_USERNAME}" class="form-control input-sm input300" autocapitalize="off" autocomplete="no" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input
                                            type="password" name="web_password" id="web_password" value="${sickchill.WEB_PASSWORD|hide}"
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="number" min="1" step="1" name="web_port" id="web_port" value="${sickchill.WEB_PORT}" class="form-control input-sm input100" autocapitalize="off" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" name="notify_on_login" class="enabler" id="notify_on_login" ${('', 'checked="checked"')[bool(sickchill.NOTIFY_ON_LOGIN)]}/>
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" name="web_ipv6" id="web_ipv6" ${('', 'checked="checked"')[bool(sickchill.WEB_IPV6)]}/>
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" name="enable_https" class="enabler" id="enable_https" ${('', 'checked="checked"')[bool(sickchill.ENABLE_HTTPS)]}/>
                        ...
                        <div id="content_enable_https">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="text" name="https_cert" id="https_cert" value="${sickchill.HTTPS_CERT}" class="form-control input-sm input300" autocapitalize="off" />
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="text" name="https_key" id="https_key" value="${sickchill.HTTPS_KEY}" class="form-control input-sm input300" autocapitalize="off" />
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="checkbox" name="handle_reverse_proxy" id="handle_reverse_proxy" ${('', 'checked="checked"')[bool(sickchill.HANDLE_REVERSE_PROXY)]}/>
                    ...
                    <fieldset class="component-group-list">
                                    ...
                                    <div class="col-md-12">
                                        <select id="cpu_presets" name="cpu_preset" class="form-control input-sm input250">
                                            % for cur_preset in cpu_presets:
                                                <option value="${cur_preset}" ${('', 'selected="selected"')[sickchill.CPU_PRESET == cur_preset]}>${cur_preset.capitalize()}</option>
                                            % endfor
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="text" name="anon_redirect" value="${sickchill.ANON_REDIRECT}" class="form-control input-sm input300" autocapitalize="off" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" name="debug" id="debug" ${('', 'checked="checked"')[bool(sickchill.DEBUG)]}/>
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" name="ssl_verify" id="ssl_verify" ${('', 'checked="checked"')[bool(sickchill.SSL_VERIFY)]}/>
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="checkbox" name="no_restart" id="no_restart" ${('', 'checked="checked"')[bool(sickchill.NO_RESTART)]}/>
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="checkbox" name="encryption_version" id="encryption_version" ${('', 'checked="checked"')[bool(sickchill.ENCRYPTION_VERSION)]}/>
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="checkbox" name="calendar_unprotected" id="calendar_unprotected" ${('', 'checked="checked"')[bool(sickchill.CALENDAR_UNPROTECTED)]}/>
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" name="calendar_icons" id="calendar_icons" ${('', 'checked="checked"')[bool(sickchill.CALENDAR_ICONS)]}/>
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="text" name="proxy_setting" value="${sickchill.PROXY_SETTING}" class="form-control input-sm input300" autocapitalize="off" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="checkbox" name="proxy_indexers" id="proxy_indexers" ${('', 'checked="checked"')[bool(sickchill.PROXY_INDEXERS)]}/>
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="checkbox" name="skip_removed_files" id="skip_removed_files" ${('', 'checked="checked"')[bool(sickchill.SKIP_REMOVED_FILES)]}/>
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="checkbox" name="ignore_broken_symlinks" id="ignore_broken_symlinks" ${('', 'checked="checked"')[bool(sickchill.IGNORE_BROKEN_SYMLINKS)]}/>
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        % if not sickchill.SKIP_REMOVED_FILES:
                                            <select name="ep_default_deleted_status" id="ep_default_deleted_status" class="form-control input-sm input250" title="Default delete status">
                                                % for defStatus in [SKIPPED, IGNORED, ARCHIVED]:
                                                    <option value="${defStatus}" ${('', 'selected="selected"')[int(sickchill.EP_DEFAULT_DELETED_STATUS) == defStatus]}>${statusStrings[defStatus]}</option>
                                                % endfor
                                            </select>
                                        % else:
                                            <select name="ep_default_deleted_status" id="ep_default_deleted_status" class="form-control input-sm input250" disabled="disabled" title="Default delete status">
                                                % for defStatus in [SKIPPED, IGNORED]:
                                                    <option value="${defStatus}" ${('', 'selected="selected"')[sickchill.EP_DEFAULT_DELETED_STATUS == defStatus]}>${statusStrings[defStatus]}</option>
                                                % endfor
                                            </select>
                                            <input type="hidden" name="ep_default_deleted_status" value="${sickchill.EP_DEFAULT_DELETED_STATUS}" />
                                        % endif
                                    </div>
                                </div>
                                <div class="row">
                    ...
                    <fieldset class="component-group-list">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <% loading_spinner = static_url('images/loading16' + ('', '-dark')[sickchill.THEME_NAME == 'dark'] + '.gif') %>
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="radio" name="git_auth_type" id="git_auth_type_basic" value="0" ${('', 'checked="checked"')[sickchill.GIT_AUTH_TYPE == 0]}/>
                                        <label for="git_auth_type_basic">${_('Username and password')}</label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="radio" name="git_auth_type" id="git_auth_type_token" value="1" ${('', 'checked="checked"')[sickchill.GIT_AUTH_TYPE == 1]}/>
                        ...
                        <div name="content_github_auth_type">
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="git_username" id="git_username" value="${sickchill.GIT_USERNAME}" class="form-control input-sm input300" autocapitalize="off" autocomplete="no" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="password" name="git_password" id="git_password" value="${sickchill.GIT_PASSWORD|hide}"
                                                   class="form-control input-sm input300" autocomplete="no" autocapitalize="off" />
                                        </div>
                                    </div>
                                    <div class="row">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input
                                                type="text" name="git_token" id="git_token" value="${sickchill.GIT_TOKEN|hide}"
                                                class="form-control input-sm input350" autocapitalize="off" autocomplete="no"
                                            />
                                            % if not sickchill.GIT_TOKEN:
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="text" name="git_remote" id="git_remote" value="${sickchill.GIT_REMOTE}" class="form-control input-sm input300" autocapitalize="off" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="text" id="git_path" name="git_path" value="${sickchill.GIT_PATH}" class="form-control input-sm input300" autocapitalize="off" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                        ...
                        <div class="field-pair row" hidden>
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox" name="git_reset" id="git_reset" ${('', 'checked="checked"')[bool(sickchill.GIT_RESET)]}/>
