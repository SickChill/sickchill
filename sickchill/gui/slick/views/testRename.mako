...
<%block name="content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <blockquote>
                % if show.air_by_date and sickchill.NAMING_CUSTOM_ABD:
                    ${sickchill.NAMING_ABD_PATTERN}
                % elif show.is_sports and sickchill.NAMING_CUSTOM_SPORTS:
                    ${sickchill.NAMING_SPORTS_PATTERN}
                % elif show.is_anime and sickchill.NAMING_CUSTOM_ANIME:
                    ${sickchill.NAMING_CUSTOM_ANIME}
                %else:
