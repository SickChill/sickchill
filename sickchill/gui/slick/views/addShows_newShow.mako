            ...
            <div class="col-md-12">
                <form id="addShowForm" method="post" action="${srRoot}/addShows/addNewShow" accept-charset="utf-8">
                    ...
                    <div class="row stepDiv">
                        <div class="col-md-12">
                            <input type="hidden" id="indexer_timeout" value="${sickchill.INDEXER_TIMEOUT}"/>

                            % if use_provided_info:
                                <label>${_('Show retrieved from existing metadata')}:
                                    <a href="${anon_url(sickchill.indexerApi(provided_indexer).config['show_url'], provided_indexer_id)}">${provided_indexer_name}</a>
                                </label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <select name="indexerLang" id="indexerLangSelect"
                                                        ...
                                                        data-language="${sickchill.INDEXER_DEFAULT_LANGUAGE}"
                                                        data-available="${','.join(sickchill.indexerApi().config['valid_languages'])}"></select>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
