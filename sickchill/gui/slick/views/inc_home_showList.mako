<%!
    ...
    from sickchill import network_timezones
...
% if sickchill.HOME_LAYOUT == 'poster':
    <div id="${('container', 'container-anime')[curListType == 'Anime']}" class="show-grid clearfix">
        <div class="posterview">
            % for curLoadingShow in sickchill.showQueueScheduler.action.loading_show_list:
            ...
            <tbody>
                % for curLoadingShow in sickchill.showQueueScheduler.action.loading_show_list:
                    ...
                    <tr>
                        ...
                        % if sickchill.HOME_LAYOUT == 'small':
                            <td class="tvShow">
                                <div class="imgsmallposter ${sickchill.HOME_LAYOUT}">
                                    ...
                                    % endif
                                    <img src="" data-src="${srRoot}/showPoster/?show=${loading_show.id | u}&amp;which=poster_thumb" class="${sickchill.HOME_LAYOUT}" alt="${loading_show.name}"/>
                                    % if curLoadingShow.show:
                                        </a>
                        ...
                        % elif sickchill.HOME_LAYOUT == 'banner':
                            <td>
                                <span style="display: none;">${_('Loading...')} (${loading_show.name})</span>
                                <div class="imgbanner ${sickchill.HOME_LAYOUT}">
                                    % if curLoadingShow.show:
                                        <a href="${srRoot}/home/displayShow?show=${loading_show.id | u}">
                                    % endif
                                    <img src="" data-src="${srRoot}/showPoster/?show=${loading_show.id | u}&amp;which=banner" class="${sickchill.HOME_LAYOUT}" alt="${loading_show.name}" title="${loading_show.name}"/>
                                    % if curLoadingShow.show:
                                        </a>
                                    % endif
                                </div>
                            </td>
                        % elif sickchill.HOME_LAYOUT == 'simple':
                            <td class="tvShow">
                                % if curLoadingShow.show:
                ...
                % for curShow in myShowList:
                    ...
                    <tr>
                            ...
                            <td class="tvShow">
                                <div class="imgsmallposter ${sickchill.HOME_LAYOUT}">
                                    <a href="${srRoot}/home/displayShow?show=${curShow.indexerid}" title="${curShow.name}">
                                        <img src="" data-src="${srRoot}/showPoster/?show=${curShow.indexerid}&amp;which=poster_thumb" class="${sickchill.HOME_LAYOUT}" alt="${curShow.indexerid}"/>
                                    </a>
                            ...
                            <td>
                                ...
                                <div class="imgbanner ${sickchill.HOME_LAYOUT}">
                                    <a href="${srRoot}/home/displayShow?show=${curShow.indexerid}">
                                        <img src="" data-src="${srRoot}/showPoster/?show=${curShow.indexerid}&amp;which=banner" class="${sickchill.HOME_LAYOUT}" alt="${curShow.indexerid}" title="${curShow.name}"/>
                                    </a>
                                </div>
                            </td>
                        % elif sickchill.HOME_LAYOUT == 'simple':
                        ...
                        % if sickchill.HOME_LAYOUT != 'simple':
                            <td align="center">
                                % if curShow.network:
