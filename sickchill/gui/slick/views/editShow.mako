                        ...
                        <div id="main">
                            ...
                            <fieldset class="component-group-list">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <select name="indexerLang" id="indexerLangSelect"
                                                        ...
                                                        data-available="${','.join(sickchill.indexerApi().config['valid_languages'])}" title="indexerLang">
                                                </select>
                                            </div>
                                        </div>
                                        <div class="row">
                                ...
                                <div class="field-pair row">
                                    ...
                                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                        <input type="checkbox" class="enabler" id="subtitles" name="subtitles" ${('', 'checked="checked"')[show.subtitles == 1 and sickchill.USE_SUBTITLES is True]} ${('disabled="disabled"', '')[bool(sickchill.USE_SUBTITLES)]}/>
                        ...
                        <div id="format">
                            ...
                            <fieldset class="component-group-list">
                                ...
                                <div class="field-pair row">
                                    ...
                                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                        <input type="checkbox" id="season_folders" name="season_folders" ${('', 'checked="checked"')[show.season_folders == 1 or sickchill.NAMING_FORCE_FOLDERS]} ${('', 'disabled="disabled"')[bool(sickchill.NAMING_FORCE_FOLDERS)]} title="season_folders"/>
