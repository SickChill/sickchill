...
<%!
    import sickchill
    from sickchill import subtitles
                    ...
                    <fieldset class="component-group-list">
                        ...
                        <div class="field-pair row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                <input type="checkbox"
                                       class="enabler" ${('', ' checked="checked"')[bool(sickchill.USE_SUBTITLES)]}
                        ...
                        <div id="content_use_subtitles">
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" value="${sickchill.SUBTITLES_DIR}" id="subtitles_dir"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="number" name="subtitles_finder_frequency"
                                                   value="${sickchill.SUBTITLES_FINDER_FREQUENCY}" hours="1" min="1"
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="checkbox"
                                                   class="enabler" ${('', ' checked="checked"')[bool(sickchill.SUBTITLES_INCLUDE_SPECIALS)]}
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="checkbox"
                                                   class="enabler" ${('', ' checked="checked"')[bool(sickchill.SUBTITLES_PERFECT_MATCH)]}
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="subtitles_history"
                                           id="subtitles_history" ${('', 'checked="checked"')[bool(sickchill.SUBTITLES_HISTORY)]}/>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="checkbox" name="subtitles_multi"
                                                   id="subtitles_multi" ${('', 'checked="checked"')[bool(sickchill.SUBTITLES_MULTI)]}/>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="checkbox" name="subtitles_keep_only_wanted"
                                                   id="subtitles_keep_only_wanted" ${('', 'checked="checked"')[bool(sickchill.SUBTITLES_KEEP_ONLY_WANTED)]}/>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="checkbox" name="embedded_subtitles_all"
                                                   id="embedded_subtitles_all" ${('', 'checked="checked"')[bool(sickchill.EMBEDDED_SUBTITLES_ALL)]}/>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    <input type="checkbox" name="subtitles_hearing_impaired"
                                           id="subtitles_hearing_impaired" ${('', 'checked="checked"')[bool(sickchill.SUBTITLES_HEARING_IMPAIRED)]}/>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="subtitles_extra_scripts"
                                                   value="${'|'.join(sickchill.SUBTITLES_EXTRA_SCRIPTS)}"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <ul id="service_order_list">
                                    % for curService in sickchill.subtitles.sorted_service_list():
                                ...
                                <input type="hidden" name="service_order" id="service_order"
                                       value="${' '.join(['%s:%d' % (x['name'], x['enabled']) for x in sickchill.subtitles.sorted_service_list()])}"/>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                    <fieldset class="component-group-list">
                        <%
                            providerLoginDict = {
                                'legendastv': {'user': sickchill.LEGENDASTV_USER, 'pass': sickchill.LEGENDASTV_PASS},
                                'addic7ed': {'user': sickchill.ADDIC7ED_USER, 'pass': sickchill.ADDIC7ED_PASS},
                                'itasa': {'user': sickchill.ITASA_USER, 'pass': sickchill.ITASA_PASS},
                                'opensubtitles': {'user': sickchill.OPENSUBTITLES_USER, 'pass': sickchill.OPENSUBTITLES_PASS},
                                'subscenter': {'user': sickchill.SUBSCENTER_USER, 'pass': sickchill.SUBSCENTER_PASS}
                            }
                        %>
                        % for curService in sickchill.subtitles.sorted_service_list():
                            <%
