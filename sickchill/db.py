...
def db_full_path(filename="sickbeard.db", suffix=None):
    ...
    return ek(os.path.join, sickchill.DATA_DIR, filename)
...
class DBConnection(object):
    ...
    def _unicode_text_factory(x):
        ...
        try:
            ...
            return six.text_type(x, sickchill.SYS_ENCODING, errors="ignore")
...
def restore_database(version):
    ...
    if not sickchill.helpers.restoreVersionedFile(db_full_path(suffix="v" + str(version)), version):
