...
class Notifier(object):
    def __init__(self):
        self.headers = {
            ...
            'X-Plex-Client-Identifier': sickchill.sickbeard.common.USER_AGENT,
    ...
    def _notify_pht(message, title='SickChill', host=None, username=None, password=None, force=False):
        ...
        return sickchill.sickbeard.notifiers.kodi_notifier._notify_kodi(message, title=title, host=host, username=username, password=password, force=force, dest_app="PLEX")
