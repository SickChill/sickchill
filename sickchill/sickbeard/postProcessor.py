...
import sickchill.sickbeard.subtitles
    ...
    def _combined_file_operation(self, file_path, new_path,
        ...
        for cur_file_path in file_list:
            ...
            if cur_extension in SUBTITLE_EXTENSIONS and '.' in cur_file_name:
                ...
                cur_lang_name = sickchill.sickbeard.subtitles.from_code(cur_lang).name
    ...
    def _copy(self, file_path, new_path, new_base_name, associated_files=False, subtitles=False):
        ...
        def _int_copy(cur_file_path, new_file_path):
            ...
            try:
                ...
                self._log("Unable to copy file " + cur_file_path + " to " + new_file_path + ": " + str(e), logger.ERROR)
                raise
    ...
    def _get_ep_obj(self, show, season, episodes):
        ...
        for cur_episode in episodes:
            ...
            try:
                ...
                self._log("Unable to create episode: " + str(e), logger.DEBUG)
