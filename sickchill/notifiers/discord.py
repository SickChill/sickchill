...
class Notifier(object):
    ...
    def _send_discord(self, message=None):
        discord_webhook = sickchill.DISCORD_WEBHOOK
        discord_name = sickchill.DISCORD_NAME
        avatar_icon = sickchill.DISCORD_AVATAR_URL
        discord_tts = bool(sickchill.DISCORD_TTS)
    ...
    def _notify_discord(self, message='', force=False):
        if not sickchill.USE_DISCORD and not force:
            return False
