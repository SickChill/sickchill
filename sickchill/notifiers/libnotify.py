...
class Notifier(object):
    ...
    def _notify(self, title, message, force=False):
        if self.notify_initialized and sickchill.USE_LIBNOTIFY | force:
            icon = ek(os.path.join, sickchill.PROG_DIR, 'gui', 'slick', 'images', 'ico', 'favicon-120.png')
