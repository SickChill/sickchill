...
class Notifier(object):
    ...
    def notify_snatch(self, ep_name):
        if sickchill.PUSHALOT_NOTIFY_ONSNATCH:
            self._sendPushalot(
    ...
    def notify_download(self, ep_name):
        if sickchill.PUSHALOT_NOTIFY_ONDOWNLOAD:
            self._sendPushalot(
                pushalot_authorizationtoken=None,
    ...
    def notify_subtitle_download(self, ep_name, lang):
        if sickchill.PUSHALOT_NOTIFY_ONSUBTITLEDOWNLOAD:
            self._sendPushalot(
                pushalot_authorizationtoken=None,
    ...
    def _sendPushalot(self, pushalot_authorizationtoken=None, event=None, message=None, force=False):
        ...
        if not (sickchill.USE_PUSHALOT or force):
            return False

        pushalot_authorizationtoken = pushalot_authorizationtoken or sickchill.PUSHALOT_AUTHORIZATIONTOKEN
        ...
        jdata = sickchill.helpers.getURL(
