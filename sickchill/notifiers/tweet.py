...
class Notifier(object):
    ...
    def _get_authorization(self):
        ...
        try:
            ...
            sickchill.TWITTER_USERNAME = request_token['oauth_token']
            sickchill.TWITTER_PASSWORD = request_token['oauth_token_secret']
    ...
    def _get_credentials(self, key):
        ...
        oauth_session = OAuth1Session(client_key=self.consumer_key,
                                      ...
                                      resource_owner_key=sickchill.TWITTER_USERNAME,
                                      resource_owner_secret=sickchill.TWITTER_PASSWORD)
        ...
        sickchill.TWITTER_USERNAME = access_token['oauth_token']
        sickchill.TWITTER_PASSWORD = access_token['oauth_token_secret']
        return True
    ...
    def _send_tweet(self, message=None):
        ...
        api = twitter.Api(consumer_key=self.consumer_key,
                          ...
                          access_token_key=sickchill.TWITTER_USERNAME,
                          access_token_secret=sickchill.TWITTER_PASSWORD)
    ...
    def _notifyTwitter(self, message='', force=False):
        prefix = sickchill.TWITTER_PREFIX

        if not sickchill.USE_TWITTER and not force:
            return False

        if sickchill.TWITTER_USEDM and sickchill.TWITTER_DMTO:
