...
class Notifier(object):
    ...
    def update_library(self, ep_obj):
        ...
        trakt_id = sickchill.indexerApi(ep_obj.show.indexer).config['trakt_id']
        ...
        if sickchill.USE_TRAKT:
            try:
                ...
                if sickchill.TRAKT_SYNC_WATCHLIST and sickchill.TRAKT_REMOVE_SERIESLIST:
                ...
                if sickchill.TRAKT_SYNC_WATCHLIST and sickchill.TRAKT_REMOVE_WATCHLIST:
                    trakt_api.traktRequest("sync/watchlist/remove", data, method='POST')
