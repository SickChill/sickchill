...
class Notifier(object):
    ...
    def _send_slack(self, message=None):
        slack_webhook = self.SLACK_WEBHOOK_URL + sickchill.SLACK_WEBHOOK.replace(self.SLACK_WEBHOOK_URL, '')
    ...
    def _notify_slack(self, message='', force=False):
        if not sickchill.USE_SLACK and not force:
            return False
