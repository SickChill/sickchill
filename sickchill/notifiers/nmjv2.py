...
class Notifier(object):
            ...
            for node in xml.getElementsByTagName('path'):
                ...
                if returnvalue == "0":
                    ...
                    if dbloc == "local" and DB_path.find("localhost") > -1:
                        sickchill.NMJv2_HOST = host
                        sickchill.NMJv2_DATABASE = DB_path
                        return True
    ...
    def _sendNMJ(self, host):
        ...
        try:
            url_scandir = "http://" + host + ":8008/metadata_database?arg0=update_scandir&arg1=" + sickchill.NMJv2_DATABASE + "&arg2=&arg3=update_all"
            logger.log("NMJ scan update command sent to host: {0}".format(host), logger.DEBUG)
            url_updatedb = "http://" + host + ":8008/metadata_database?arg0=scanner_start&arg1=" + sickchill.NMJv2_DATABASE + "&arg2=background&arg3="
