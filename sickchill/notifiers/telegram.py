...
class Notifier(object):
    ...
    def _send_telegram_msg(self, title, msg, id=None, api_key=None):
        ...
        """
        id = sickchill.TELEGRAM_ID if id is None else id
        api_key = sickchill.TELEGRAM_APIKEY if api_key is None else api_key
    ...
    def notify_snatch(self, ep_name, title=notifyStrings[NOTIFY_SNATCH]):
        ...
        :param title: The title of the notification to send
        """
        if sickchill.TELEGRAM_NOTIFY_ONSNATCH:
    ...
    def notify_download(self, ep_name, title=notifyStrings[NOTIFY_DOWNLOAD]):
        ...
        :param title: The title of the notification to send
        """
        if sickchill.TELEGRAM_NOTIFY_ONDOWNLOAD:
            self._notify_telegram(title, ep_name)
    ...
    def notify_subtitle_download(self, ep_name, lang, title=notifyStrings[NOTIFY_SUBTITLE_DOWNLOAD]):
        ...
        :param title: The title of the notification to send
        """
        if sickchill.TELEGRAM_NOTIFY_ONSUBTITLEDOWNLOAD:
    ...
    def _notify_telegram(self, title, message, id=None, api_key=None, force=False):
        ...
        if not (force or sickchill.USE_TELEGRAM):
