...
class Notifier(object):
    ...
    def _send_join_msg(self, title, msg, id=None, apikey=None):
        ...
        """
        id = sickchill.JOIN_ID if id is None else id
        apikey = sickchill.JOIN_APIKEY if apikey is None else apikey
    ...
    def notify_snatch(self, ep_name, title=notifyStrings[NOTIFY_SNATCH]):
        ...
        :param title: The title of the notification to send
        """
        if sickchill.JOIN_NOTIFY_ONSNATCH:
    ...
    def notify_download(self, ep_name, title=notifyStrings[NOTIFY_DOWNLOAD]):
        ...
        :param title: The title of the notification to send
        """
        if sickchill.JOIN_NOTIFY_ONDOWNLOAD:
            self._notify_join(title, ep_name)
    ...
    def notify_subtitle_download(self, ep_name, lang, title=notifyStrings[NOTIFY_SUBTITLE_DOWNLOAD]):
        ...
        :param title: The title of the notification to send
        """
        if sickchill.JOIN_NOTIFY_ONSUBTITLEDOWNLOAD:
    ...
    def _notify_join(self, title, message, id=None, apikey=None, force=False):
        ...
        if not (force or sickchill.USE_JOIN):
