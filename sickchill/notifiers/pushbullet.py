...
import sickchill
from sickchill import common, helpers, logger
...
class Notifier(object):
    ...
    def notify_snatch(self, ep_name):
        if sickchill.PUSHBULLET_NOTIFY_ONSNATCH:
    ...
    def notify_download(self, ep_name):
        if sickchill.PUSHBULLET_NOTIFY_ONDOWNLOAD:
            self._sendPushbullet(
                pushbullet_api=None,
    ...
    def notify_subtitle_download(self, ep_name, lang):
        if sickchill.PUSHBULLET_NOTIFY_ONSUBTITLEDOWNLOAD:
            self._sendPushbullet(
                pushbullet_api=None,
    ...
    def _sendPushbullet(  # pylint: disable=too-many-arguments
        ...
        if not (sickchill.USE_PUSHBULLET or force):
            return False

        pushbullet_api = pushbullet_api or sickchill.PUSHBULLET_API
        pushbullet_device = pushbullet_device or sickchill.PUSHBULLET_DEVICE
        pushbullet_channel = pushbullet_channel or sickchill.PUSHBULLET_CHANNEL
