...
class Notifier(object):
    ...
    def _send_growl(self, options, message=None):
        ...
        if options['icon']:
            notice.add_header('Notification-Icon', sickchill.LOGO_URL)
    ...
    def _sendGrowl(self, title="SickChill Notification", message=None, name=None, host=None, password=None,
                   force=False):
        if not sickchill.USE_GROWL and not force:
            return False
        ...
        if host is None:
            hostParts = sickchill.GROWL_HOST.split(':')
        else:
        ...
        if password is None:
            opts['password'] = sickchill.GROWL_PASSWORD
        else:
    ...
    def _sendRegistration(self, host=None, password=None, name='SickChill Notification'):
        ...
        register.add_header('Application-Icon', sickchill.LOGO_URL)
