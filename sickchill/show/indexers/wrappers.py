...
class ExceptionDecorator(object):
    ...
    def __init__(self, default_return=None, catch=(HTTPError, HTTPWarning, requests.exceptions.RequestException, requests.exceptions.RequestsWarning, TypeError), image_api=False):
