...
class TVEpisode(object):
    ...
    def _replace_map(self):
        ...
        return {
            ...
            '%S': str(self.season) if self.season else '',
            '%0S': f'{int(self.season):02d}' if self.season else '',
            '%E': str(self.episode) if self.episode else '',
            '%0E': f'{int(self.episode):02d}' if self.episode else '',
            '%XS': str(self.scene_season) if self.scene_season else '',
            '%0XS': f'{int(self.scene_season):02d}' if self.scene_season else '',
            '%XE': str(self.scene_episode) if self.scene_episode else '',
            '%0XE': f'{int(self.scene_episode):02d}' if self.scene_episode else '',
            '%AB': f'{int(self.absolute_number):03d}' if self.absolute_number else '',
            '%XAB': f'{int(self.scene_absolute_number):03d}' if self.scene_absolute_number else '',
