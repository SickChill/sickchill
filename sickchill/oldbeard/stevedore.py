...
clients = RegistrableExtensionManager('oldbeard.clients', [
...
providers = RegistrableExtensionManager('oldbeard.providers', [
...
notifiers = RegistrableExtensionManager('oldbeard.notifiers', [
