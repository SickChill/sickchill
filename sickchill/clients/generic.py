...
class GenericClient(object):  # pylint: disable=too-many-instance-attributes
    def __init__(self, name, host=None, username=None, password=None):
        ...
        self.name = name
        self.username = sickchill.TORRENT_USERNAME if not username else username
        self.password = sickchill.TORRENT_PASSWORD if not password else password
        self.host = sickchill.TORRENT_HOST if not host else host
