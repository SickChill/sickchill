...
class uTorrentAPI(GenericClient):
    ...
    def _get_auth(self):
        ...
        try:
            ...
            sickchill.helpers.handle_requests_exception(error)
            self.auth = None
    ...
    def _set_torrent_label(self, result):
        ...
        params: :result: an instance of the searchResult class
        """
        label = sickchill.TORRENT_LABEL_ANIME or sickchill.TORRENT_LABEL if result.show.is_anime else sickchill.TORRENT_LABEL
        params = {
            'action': 'setprops',
            'hash': result.hash,
            's': 'label',
    ...
    def _set_torrent_seed_time(self, result):
        ...
        params: :result: an instance of the searchResult class
        """
        if not sickchill.TORRENT_SEED_TIME:
            return True
        ...
        params = {
            ...
            'hash': result.hash,
            's': 'seed_time',
            'v': 3600 * float(sickchill.TORRENT_SEED_TIME)
        }
        return self._request(params=params)
    ...
    def _set_torrent_pause(self, result):
        ...
        """
        params = {
            'action': 'pause' if sickchill.TORRENT_PAUSED else 'start',
            'hash': result.hash
        }
        return self._request(params=params)
