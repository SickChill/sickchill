...
class DelugeDAPI(GenericClient):
    ...
    def _add_torrent_uri(self, result):
        ...
        options = {
            'add_paused': sickchill.TORRENT_PAUSED
        }
    ...
    def _set_torrent_label(self, result):
        ...
        label = sickchill.TORRENT_LABEL.lower()
        if result.show.is_anime:
            label = sickchill.TORRENT_LABEL_ANIME.lower()
        if ' ' in label:
    ...
    def _set_torrent_path(self, result):
        if sickchill.TORRENT_PATH:
            return self.drpc.set_torrent_path(result.hash, sickchill.TORRENT_PATH)
        return True
