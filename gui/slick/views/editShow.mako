							...
							<fieldset class="component-group-list">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" id="subtitles"
                                           name="subtitles" ${('', 'checked="checked"')[show.subtitles == 1 and sickbeard.USE_SUBTITLES is True]} ${('disabled="disabled"', '')[bool(sickbeard.USE_SUBTITLES)]}/> ${_('search for subtitles')}
                                </span>
									</label>
								</div>
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" id="paused"
                                           name="paused" ${('', 'checked="checked"')[show.paused == 1]} /> ${_('pause this show (SickRage will not download episodes)')}
                                </span>
									</label>
								</div>
							...
							<fieldset class="component-group-list">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" id="airbydate"
                                           name="air_by_date" ${('', 'checked="checked"')[show.air_by_date == 1]} /> ${_('check if the show is released as Show.03.02.2010 rather than Show.S02E03.')}
	                                <br>
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" id="anime"
                                           name="anime" ${('', 'checked="checked"')[show.is_anime == 1]}> ${_('check if the show is Anime and episodes are released as Show.265 rather than Show.S02E03')}
	                                <br>
                                    % if show.is_anime:
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" id="sports"
                                           name="sports" ${('', 'checked="checked"')[show.sports == 1]}/> ${_('check if the show is a sporting or MMA event released as Show.03.02.2010 rather than Show.S02E03')}
	                                <br>
                                    <span style="color:red">${_('In case of an air date conflict between regular and special episodes, the later will be ignored.')}</span>
                                </span>
									</label>
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" id="season_folders"
                                           name="flatten_folders" ${('checked="checked"', '')[show.flatten_folders == 1 and not sickbeard.NAMING_FORCE_FOLDERS]} ${('', 'disabled="disabled"')[bool(sickbeard.NAMING_FORCE_FOLDERS)]}/> ${_('group episodes by season folder (uncheck to store in a single folder)')}
                                </span>
									</label>
								</div>
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" id="scene"
                                           name="scene" ${('', 'checked="checked"')[show.scene == 1]} /> ${_('search by scene numbering (uncheck to search by indexer numbering)')}
                                </span>
									</label>
								</div>
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" id="dvdorder"
                                           name="dvdorder" ${('', 'checked="checked"')[show.dvdorder == 1]} /> ${_('use the DVD order instead of the air order')}
	                                <br>
							...
							<fieldset class="component-group-list">
                                ...
                                <span class="component-desc">
                                    <input type="text" id="SceneName"
                                           class="form-control form-control-inline input-sm input200"
                                           autocapitalize="off"/><input class="btn btn-inline" type="button"
                                                                        value="${_('Add')}" id="addSceneName"/><br><br>
                                    <div class="pull-left">
                                        ...
                                        <div><input id="removeSceneName" value="${_('Remove')}" class="btn float-left"
