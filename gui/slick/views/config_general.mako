                                    ...
                                    <fieldset class="component-group-list">
                                        ...
                                        <div class="field-pair">
                                            <label for="showupdate_hour">
                                                ...
                                                <span class="component-desc">
                                                    ...
                                                    ${_('with information such as next air dates, show ended, etc. Use 15 for 3pm, 4 for 4am etc.')}
                                                    ${_('Note: minutes are randomized each time SickRage is started')}
                                                </span>
                                            </label>
                                        </div>
                                        ...
                                        <div class="field-pair">
                                            <label for="log_dir">
                                                ...
                                                <span class="component-desc">
                                                    <input type="text" name="log_dir" id="log_dir" value="${sickbeard.ACTUAL_LOG_DIR}" class="form-control input-sm" autocapitalize="off" />
                                                </span>
                                            </label>
                                        </div>
                                            ...
                                            <label for="log_nr">
                                                ...
                                                <span class="component-desc">
                                                    <div>
                                                        ...
                                                        ${_('number of log files saved when rotating logs (default: 5) (REQUIRES RESTART)')}
                                                    </div>
                                                </span>
                                            </label>
                                        </div>
                                        ...
                                        <div class="field-pair">
                                            <label for="log_size">
                                                ...
                                                <span class="component-desc">
                                                    ...
                                                    ${_('maximum size in MB of the log file (default: 1MB) (REQUIRES RESTART)')}
                                                </span>
                                            </label>
                                        </div>
                                        ...
                                        <div class="field-pair">
                                            <label for="indexer_timeout">
                                                ...
                                                <span class="component-desc">
                                                    ...
                                                    ${_('seconds of inactivity when finding new shows (default:20)')}
                                                </span>
                                            </label>
                                        </div>
