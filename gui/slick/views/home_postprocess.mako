        ...
        <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
            ...
            <form name="processForm" method="post" action="processEpisode" style="line-height: 40px;">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="process_directory" id="process_directory" class="form-control form-control-inline input-sm input250" autocapitalize="off" title="directory"/>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
