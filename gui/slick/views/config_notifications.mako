    ...
    <div id="config-content">
        <form id="configForm" action="saveNotifications" method="post">
            <div id="config-components">
                ...
                <div class="component-group">
                    ...
                    <div class="component-group-desc">
                        <img class="icon-notifiers-kodi" title=" KODI" />
                ...
                <div class="component-group">
                    <div class="component-group-desc">
                        <img class="icon-notifiers-plex" title=" Plex Media Server" />
                ...
                <div class="component-group">
                    <div class="component-group-desc">
                        <img class="icon-notifiers-plexth" title=" Plex Home Theater" />
                 ...
                 <div class="component-group">
                     <div class="component-group-desc">
                        <img class="icon-notifiers-emby" alt="" title=" Emby" />
                ...
                <div class="component-group">
                    <div class="component-group-desc">
                        <img class="icon-notifiers-nmj" alt="" title=" Networked Media Jukebox" />
                ...
                <div class="component-group">
                    <div class="component-group-desc">
                        <img class="icon-notifiers-nmj" alt="" title=" Networked Media Jukebox v2"/>
                ...
                <div class="component-group">
                    <div class="component-group-desc">
                        <img class="icon-notifiers-syno1" alt="" title=" Synology" />
                ...
                <div class="component-group">
                    <div class="component-group-desc">
                        <img class="icon-notifiers-syno2" alt="" title=" Synology Indexer" />
                ...
                <div class="component-group">
                    <div class="component-group-desc">
                        <img class="icon-notifiers-pytivo" alt="" title=" pyTivo" />
            ...
            <div id="tabs-2">
                <div class="component-group">
                    <div class="component-group-desc">
                        <img class="icon-notifiers-growl" alt="" title=" Growl" />
                ...
                <div class="component-group">
                    <div class="component-group-desc">
                        <img class="icon-notifiers-prowl" title=" Prowl" />
                ...
                <div class="component-group">
                    <div class="component-group-desc">
                        <img class="icon-notifiers-libnotify" title=" Libnotify" />
                ...
                <div class="component-group">
                    <div class="component-group-desc">
                        <img class="icon-notifiers-pushover" alt="" title=" Pushover" />
                ...
                <div class="component-group">
                    <div class="component-group-desc">
                        <img class="icon-notifiers-boxcar2" alt="" title=" Boxcar 2"/>
                ...
                <div class="component-group">
                    <div class="component-group-desc">
                        <img class="icon-notifiers-nma" alt="" title=" NMA"/>
                ...
                <div class="component-group">
                    <div class="component-group-desc">
                        <img class="icon-notifiers-pushalot" alt="" title=" Pushalot" />
                ...
                <div class="component-group">
                    <div class="component-group-desc">
                        <img class="icon-notifiers-pushbullet" alt="" title=" Pushbullet" />
                ...
                <div class="component-group">
                    <div class="component-group-desc">
                        <img class="icon-notifiers-freemobile" alt="" title=" Free Mobile" />
                ...
                <div class="component-group">
                    <div class="component-group-desc">
                        <img class="icon-notifiers-telegram" alt="" title=" Telegram" />
            ...
            <div id="tabs-3">
                <div class="component-group">
                       <div class="component-group-desc">
                        <img class="icon-notifiers-twitter" alt="" title=" Twitter"/>
                ...
                <div class="component-group">
                    <div class="component-group-desc">
                        <img class="icon-notifiers-trakt" alt="" title=" Trakt"/>
                ...
                <div class="component-group">
                    <div class="component-group-desc">
                        <img class="icon-notifiers-email" alt="" title=" Email" />
