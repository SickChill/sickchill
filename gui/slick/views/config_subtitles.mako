								...
								<div class="field-pair">
									...
									<label>
										...
										<span class="component-desc"><b>${_('Note')}
											:</b> ${_('Leave empty if you want store subtitle in episode path.')}</span>
									</label>
								</div>
								<div class="field-pair">
									<label>
										...
										<input type="number" name="subtitles_finder_frequency"
										       ...
										       step="1" class="form-control input-sm input75"/>
									...
									<label>
                                        <span class="component-desc">
                                            <ul>
                                                    ...
                                                    <li>${_('For any scripted languages, include the interpreter executable before the script. See the following example')}
	                                                    :</li>
                                                    <ul>
                                                        <li>${_('For Windows: ')}
