                            ...
                            <fieldset class="component-group-list">
                                ...
                                <div class="field-pair row">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right">
                                        <label for="use_notifo" class="pull-right">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <span class="component-desc pull-right">${_('Username of your AniDB account')}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <span class="component-desc pull-right">${_('Password of your AniDB account')}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
