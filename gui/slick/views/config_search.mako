				...
				<div id="config-components">
					...
					<div id="episode-search" class="component-group">
						<div class="component-group-desc">
							...
							<p>${_('How to manage searching with')} <a href="${srRoot}/config/providers">providers</a>.
							</p>
						</div>
							...
							<div class="field-pair">
                                ...
                                <span class="component-desc">
                                    <input type="number" min="720" step="60" name="backlog_frequency"
                                           ...
                                           autocapitalize="off"/>
                                    <p>${_('time in minutes between searches (min.')} ${sickbeard.MIN_BACKLOG_FREQUENCY}
	                                    )</p>
                                </span>
								</label>
							</div>
							...
							<div class="field-pair">
                                ...
                                <span class="component-desc">
                                    <input type="number" min="10" step="1" name="dailysearch_frequency"
                                           value="${sickbeard.DAILYSEARCH_FREQUENCY}"
                                           class="form-control input-sm input75" autocapitalize="off"/>
                                    <p>${_('time in minutes between searches (min.')} ${sickbeard.MIN_DAILYSEARCH_FREQUENCY}
	                                    )</p>
                                    </span>
								</label>
							</div>
							...
							<div id="content_use_failed_downloads">
								<div class="field-pair">
									...
									<label class="nocheck" for="delete_failed">
										<span class="component-title">&nbsp;</span>
										<span class="component-desc"><b>${_('Note')}
											:</b> ${_('This only works if Use Failed Downloads is enabled.')}</span>
									</label>
								</div>
							</div>
							...
							<div id="content_use_nzbs">
								...
								<div id="download_station_settings">
									...
									<div class="field-pair">
										<label>
											<span class="component-title"
											      id="username_title">${_('Client username')}</span>
                                    <span class="component-desc">
									...
									<div class="field-pair">
										<label>
											<span class="component-title"
											      id="password_title">${_('Client password')}</span>
                                    <span class="component-desc">
									...
									<div class="field-pair">
										<label>
											<span class="component-title"
											      id="directory_title">${_('Downloaded files location')}</span>
                                    <span class="component-desc">
                                        ...
                                        <div class="clear-left"><p>${_('where Synology Download Station will save downloaded files (blank for client default)')}
	                                        <span id="path_synology"> <b>${_('Note')}
		                                        :</b> ${_('the destination has to be a shared folder for Synology DS')}</span></p>
                                        </div>
                                    </span>
										</label>
									</div>
								...
								<div id="nzbget_settings">
                                    ...
                                    <span class="component-desc">
                                        ...
                                        <p><b>${_('Note')}
	                                        :</b> ${_('enable Secure control in NZBGet and set the correct Secure Port here')}</p>
                                    </span>
										</label>
                            ...
                            <div id="options_torrent_clients" id="torrent_host_option">
                                <div class="field-pair">
									...
									<div class="field-pair" id="torrent_rpcurl_option">
										<label>
											<span class="component-title"
											      id="rpcurl_title">${_('Torrent RPC URL')}</span>
                                        <span class="component-desc">
									...
									<div class="field-pair" id="torrent_label_option">
                                        ...
                                        <span class="component-desc">
                                            <input type="text" name="torrent_label" id="torrent_label"
                                                   ...
                                                   class="form-control input-sm input200" autocapitalize="off"/>
                                            <span id="label_warning_deluge"
                                                  style="display:none"><p>${_('(blank spaces are not allowed)')}</p>
                                                <div class="clear-left"><p>${_('note: label plugin must be enabled in Deluge clients')}</p></div>
                                            </span>
                                            <span id="label_warning_qbittorrent"
                                                  style="display:none"><p>${_('(blank spaces are not allowed)')}</p>
									...
									<div class="field-pair" id="torrent_label_anime_option">
                                        ...
                                        <span class="component-desc">
                                            <input type="text" name="torrent_label_anime" id="torrent_label_anime"
                                                   ...
                                                   class="form-control input-sm input200" autocapitalize="off"/>
                                            <span id="label_anime_warning_deluge"
                                                  style="display:none"><p>${_('(blank spaces are not allowed)')}</p>
                                                <div class="clear-left"><p>${_('note: label plugin must be enabled in Deluge clients')}</p></div>
                                            </span>
                                            <span id="label_anime_warning_qbittorrent"
                                                  style="display:none"><p>${_('(blank spaces are not allowed)')}</p>
                                                <div class="clear-left"><p>${_('note: for QBitTorrent 3.3.1 and up ')}</p></div>
                                            </span>
                                        </span>
									...
									<div class="testNotification"
									     id="test_torrent_result">${_('Click below to test')}</div>
									<input class="btn" type="button" value="${_('Test Connection')}" id="test_torrent"
									       class="btn test-button"/>
									<input type="submit" class="btn config_submitter" value="${_('Save Changes')}"/><br>
								</div>
					...
					<br>
					<h6 class="pull-right"><b>${_('All non-absolute folder locations are relative to')} <span
							class="path">${sickbeard.DATA_DIR}</span></b></h6>
