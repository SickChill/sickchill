...
<table class="infoTable" cellspacing="1" border="0" cellpadding="0" width="100%">
    % if sr_version:
    <tr><td class="infoTableHeader" style="vertical-align: top;"><i class="icon16-config-sickrage"></i> SickRage:</td>
    ...
    % endif
    <tr><td class="infoTableHeader"><i class="icon16-config-python"></i> Python:</td><td class="infoTableCell">${sys.version[:120]}</td></tr>
    <tr><td class="infoTableHeader"><i class="icon16-config-ssl"></i> SSL:</td><td class="infoTableCell">${ssl_version}</td></tr>
    ...
    <tr><td class="infoTableHeader"><i class="icon16-config-dir"></i> Path:</td><td class="infoTableCell">${sickbeard.PROG_DIR}</td></tr>
    <tr><td class="infoTableHeader"><i class="icon16-config-config"></i> Config:</td><td class="infoTableCell">${sickbeard.CONFIG_FILE}</td></tr>
    <tr><td class="infoTableHeader"><i class="icon16-config-db"></i> Database:</td><td class="infoTableCell">${db.dbFilename()}</td></tr>
    <tr><td class="infoTableHeader"><i class="icon16-config-cache"></i> Cache:</td><td class="infoTableCell">${sickbeard.CACHE_DIR}</td></tr>
    <tr><td class="infoTableHeader"><i class="icon16-config-log"></i> Log Path:</td><td class="infoTableCell">${sickbeard.LOG_DIR}</td></tr>
