...
class NcoreProvider(TorrentProvider): # pylint: disable=too-many-instance-attributes
    ...
    def __init__(self):
        ...
        self.urls = {
                   ...
                   'search': 'https://ncore.cc/torrents.php?kivalasztott_tipus[]=xvidser_hun&kivalasztott_tipus[]=xvidser&kivalasztott_tipus[]=dvd_hun&kivalasztott_tipus[]=dvd&kivalasztott_tipus[]=dvd9_hun&kivalasztott_tipus[]=dvd9&kivalasztott_tipus[]=hd_hun&kivalasztott_tipus[]=hd&mire=%s&miben=name&tipus=kivalasztottak_kozott&submit.x=0&submit.y=0&submit=Ok&tags=&searchedfrompotato=true&jsons=true',
                }
