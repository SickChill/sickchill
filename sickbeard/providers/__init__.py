...
import sickbeard
from sickbeard.providers import (abnormal, alpharatio, archetorrent, binsearch, bitcannon, gimmepeers, btn, cpasbien, danishbits, elitetorrent, filelist,
...
__all__ = [
    'abnormal', 'alpharatio', 'archetorrent', 'binsearch', 'bitcannon', 'gimmepeers', 'btn', 'cpasbien', 'danishbits',
