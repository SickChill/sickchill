...
from sickbeard.providers import btn, newznab, womble, thepiratebay, torrentleech, kat, iptorrents, torrentz, \
    ...
    scenetime, btdigg, strike, transmitthenet, tvchaosuk, bitcannon, pretome, gftracker, hdspace, newpct, elitetorrent, bitsnoop, nzbindex
...
__all__ = [
    ...
    'hdspace', 'newpct', 'elitetorrent', 'bitsnoop', 'nzbindex'
]
