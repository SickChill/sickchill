...
from sickbeard.providers import (abnormal, alpharatio, archetorrent, binsearch, bitcannon, bjshare, btn, cpasbien, danishbits, elitetorrent, filelist,
                                 ...
                                 torrentday, torrentleech, torrentproject, torrentz, tvchaosuk, xthor, yggtorrent, oxtorrent, torrent9clone)
...
__all__ = [
    ...
    'torrentbytes', 'torrentday', 'torrentleech', 'torrentproject', 'torrentz', 'tvchaosuk', 'xthor', 'yggtorrent', 'oxtorrent', 'torrent9clone'
]
