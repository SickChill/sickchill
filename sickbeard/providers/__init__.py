...
from sickbeard.providers import btn, newznab, rsstorrent, womble, thepiratebay, torrentleech, kat, iptorrents, torrentz, \
    omgwtfnzbs, scc, hdtorrents, torrentday, hdbits, hounddawgs, speedcd, nyaatorrents, bluetigers, xthor, torrentbytes, cpasbien,\
...
__all__ = [
    ...
    'xthor', 'scenetime', 'btdigg', 'transmitthenet', 'tvchaosuk',
