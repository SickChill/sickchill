...
# Edited by Jamyz for Torrent9 Clone
...
class Torrent9CloneProvider(TorrentProvider):

    def __init__(self):

        TorrentProvider.__init__(self, "Torrent9Clone")

        self.public = True
        self.minseed = None
        self.minleech = None
        self.url = "https://www.torrent9.vg"
...
provider = Torrent9CloneProvider()
