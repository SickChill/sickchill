...
class EliteTrackerFRProvider(TorrentProvider):  # pylint: disable=too-many-instance-attributes

    def __init__(self):

        TorrentProvider.__init__(self, 'EliteTrackerFR')
            ...
            for search_string in search_strings[mode]:
                ...
                with BS4Parser(data, 'html5lib') as html:
                    ...
                    for torrent in torrent_rows[1:]:
                        try:
                            if self.freeleech and not torrent.find('img', alt=re.compile('TORRENT GRATUIT : Seulement l\'upload sera compter.')):
                                continue
...
provider = EliteTrackerFRProvider()
