...
PROCESSOR_REMOVE_FINISHED_TORRENTS = False
...
def initialize(consoleLogging=True):  # pylint: disable=too-many-locals, too-many-branches, too-many-statem
    with INIT_LOCK:
        ...
        global BRANCH, GIT_RESET, GIT_REMOTE, GIT_REMOTE_URL, CUR_COMMIT_HASH, CUR_COMMIT_BRANCH, ACTUAL_LOG_DIR, LOG_DIR, LOG_NR, LOG_SIZE, WEB_PORT, WEB_LOG,\
            ...
            CPU_PRESET, UNPACK_DIR, UNRAR_TOOL, ALT_UNRAR_TOOL, KEEP_PROCESSED_DIR, PROCESS_METHOD, PROCESSOR_FOLLOW_SYMLINKS, PROCESSOR_REMOVE_FINISHED_TORRENTS, DELRARCONTENTS, \
        ...
        PROCESSOR_REMOVE_FINISHED_TORRENTS = check_setting_bool(CFG, 'General', 'processor_remove_finished_torrents')
...
def save_config():  # pylint: disable=too-many-statements, too-many-branches
    ...
    new_config.update({
        'General': {
            ...
            'processor_remove_finished_torrents': int(PROCESSOR_REMOVE_FINISHED_TORRENTS),
