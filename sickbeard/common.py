...
class Quality:
    ...
    def sceneQuality(name, anime=False):
        ...
        if checkName(["(pdtv|hdtv|dsr|tvrip).(xvid|x(264|265)|h.?264)"], all) and not checkName(["(720|1080)[pi]"], all) and\
                not checkName(["hr.ws.pdtv.x(264|265)"], any):
            return Quality.SDTV
        elif checkName(["web.dl|webrip", "xvid|x(264|265)|h.?(264|265)"], all) and not checkName(["(720|1080)[pi]"], all):
            return Quality.SDTV
        elif checkName(["(dvdrip|b[rd]rip|blue?-?ray)(.ws)?.(xvid|divx|x(264|265))"], any) and not checkName(["(720|1080)[pi]"], all):
            return Quality.SDDVD
        elif checkName(["720p", "hdtv", "x(264|265)"], all) or checkName(["hr.ws.pdtv.x(264|265)"], any) and not checkName(
                ["1080[pi]"], all):
            return Quality.HDTV
        elif checkName(["720p|1080i", "hdtv", "mpeg-?2"], all) or checkName(["1080[pi].hdtv", "h.?(264|265)"], all):
            return Quality.RAWHDTV
        elif checkName(["1080p", "hdtv", "x(264|265)"], all):
            return Quality.FULLHDTV
        elif checkName(["720p", "web.dl|webrip"], all) or checkName(["720p", "itunes", "h.?(264|265)"], all):
            return Quality.HDWEBDL
        elif checkName(["1080p", "web.dl|webrip"], all) or checkName(["1080p", "itunes", "h.?(264|265)"], all):
            return Quality.FULLHDWEBDL
        elif checkName(["720p", "blue?-?ray|hddvd|b[rd]rip", "x(264|265)"], all):
            return Quality.HDBLURAY
        elif checkName(["1080p", "blue?-?ray|hddvd|b[rd]rip", "x(264|265)"], all):
            return Quality.FULLHDBLURAY
        else:
            return Quality.UNKNOWN
