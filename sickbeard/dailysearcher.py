        ...
        for sqlEp in sql_results:
            ...
            with ep.lock:
                if ep.season == 0:
                    ...
                    logger.log(u"New episode {0!s} airs today, setting to default episode status for this show: {1!s}".format(ep.prettyName(), common.statusStrings[ep.show.default_ep_status]))
