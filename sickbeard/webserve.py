...
class ConfigSearch(Config):
    ...
    def saveSearch(self, use_nzbs=None, use_torrents=None, nzb_dir=None, sab_username=None, sab_password=None,
                   ...
                   torrent_label=None, torrent_label_anime=None, torrent_path=None, torrent_deluge_download_dir=None,
                   torrent_deluge_complete_dir=None, torrent_verify_cert=None,
        ...
        sickbeard.TORRENT_DELUGE_DOWNLOAD_DIR = torrent_deluge_download_dir.rstrip('/\\')
        sickbeard.TORRENT_DELUGE_COMPLETE_DIR = torrent_deluge_complete_dir.rstrip('/\\')
